        ...
        <b-col cols="12">
          ...
          <div class="d-sm-flex justify-content-between align-items-center px-2">
            <div class="me-3 mb-2 mb-sm-0">
              <h6 class="mb-2 mb-sm-0">آماده شروع هستید؟</h6>
              <small class="mb-0">اسناد خود را با میزل به سطح بعدی ببرید</small>
            </div>
            <a href="#" class="btn btn-sm btn-primary">تماس بگیرید</a>
          </div>
        </b-col>
      </b-row>
    </div>
