            ...
            <b-row class="g-xl-3">
                <b-col xl="8" class="d-none d-xl-block">
                    <div class="d-flex gap-4">
                        <b-card no-body class="bg-transparent">
                            <img
                                :src="portfolioList1Img"
                                class="card-img"
                                alt=""
                            />
                            <b-card-body class="px-0 text-start pb-0">
                                <h6><a href="#">مراسمی شایسته زمان</a></h6>
                                <p class="mb-2 small">
                                    ما به مشتریان خود کمک می‌کنیم حضور آنلاین
                        ...
                        <b-card no-body class="bg-transparent">
                            <img
                                :src="portfolioList2Img"
                                class="card-img"
                                alt=""
                            />
                            <b-card-body class="px-0 text-start pb-0">
                                <h6>
                                    <a href="#">ضربه‌های قلم و فراتر از آن</a>
                                </h6>
                                <p class="mb-2 small">
                                    ما به مشتریان خود کمک می‌کنیم حضور آنلاین
                                    خود را بهتر مدیریت کنند.
                ...
                <b-col xl="4">
                    <ul class="list-unstyled">
                        <li class="dropdown-header h6">صفحات نمونه کارها</li>
                        <li v-for="item in menuItems" :key="item.key">
                            <router-link
                                ...
                                :class="{
                                    active:
                                        item.route.name === currentRouteName,
                                }"
                            >
                                {{ item.label }}
                                <span
