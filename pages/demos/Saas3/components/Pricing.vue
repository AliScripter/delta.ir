<template>
  <section class="pb-0">
    <b-container>
      <b-row class="g-4 g-sm-6 g-xl-7">
        <b-col lg="6">
          <b-card no-body class="bg-light overflow-hidden p-0 h-100">
            <figure class="position-absolute top-0 end-0 mt-n6 me-n6">
              <svg
                class="fill-primary opacity-2 rtl:-scale-x-100"
                width="220px"
                height="209px"
                viewBox="0 0 220 209"
                style="enable-background: new 0 0 220 209"
                xml:space="preserve"
              >
                <path
            ...
            <b-card-body class="position-relative p-sm-6 pb-lg-0">
              <h2 class="mb-4">هر کجا، هر زمان، هر پلتفرم</h2>
              <p class="heading-color mb-4">
                اپلیکیشن را به‌صورت رایگان دانلود کنید و به تشخیص‌های دقیق گیاهان با هیچ هزینه اضافی دسترسی پیدا کنید.
              </p>
              <b-row class="g-2">
                <b-col cols="6" sm="4" lg="6" xl="4">
                  <a href="#">
            ...
            <b-card-footer class="bg-transparent p-0">
              <img :src="saasScreen" class="ms-5" alt="" />
            </b-card-footer>
          </b-card>
        </b-col>
        ...
        <b-col lg="6">
          <b-card no-body class="bg-dark overflow-hidden p-sm-4 h-100" data-bs-theme="dark">
            <div class="position-absolute end-0 bottom-0 mb-n3 me-n3">
              <img :src="patternImg" class="opacity-1 rtl:-scale-x-100" alt="" />
            </div>

            <b-card-header class="text-center bg-transparent position-relative">
              <img :src="logoIcon" class="mb-4" alt="logo-icon" />
              <h3 class="mb-2">بسته قیمت‌گذاری مقرون‌به‌صرفه</h3>
              <p>
                طرح اساسی ما یک راه‌حل خودسرویس برای کسب‌وکارها است تا به مدیریت پیام‌رسانی و شخصی‌سازی وب‌سایت بپردازند.
              </p>
            </b-card-header>

            <b-card-body class="bg-light border rounded mx-2 mx-sm-4 position-relative">
              <h6 class="mb-3">نگاهی سریع به تمام ویژگی‌ها</h6>
              <ul class="list-group list-group-borderless">
                <li
                  class="list-group-item mb-0 icons-center"
                  v-for="(feature, idx) in features"
                  :key="idx"
                >
                  <BIconPatchCheckFill class="text-primary me-2" />{{ feature }}
                </li>
              </ul>
            </b-card-body>

            <b-card-footer class="text-center bg-transparent position-relative mt-3">
              <div class="mb-4 heading-color">
                <span v-if="lang==='en'" class="h2">{{ currency }}299</span>
                <span v-else-if="lang==='fa'" class="h2">299 <small class="fs-5">{{ currency }}</small></span>
                /ماهیانه
              </div>
              <a href="#" class="btn btn-lg btn-primary w-100 mb-0">دسترسی به مدت ۱ سال را دریافت کنید</a>
            </b-card-footer>
          </b-card>
        </b-col>
      </b-row>
...
import saasScreen from '@/assets/images/elements/saas-screen.png'
...
const features = [
  'بازدیدکنندگان ماهانه نامحدود',
  'استراتژیست‌های اختصاصی SEO',
  'ویرایشگرهای سبک گوگل اسناد',
  'پشتیبانی چت و ایمیل پایه',
  'موتور توصیه محصول مبتنی بر هوش مصنوعی'
]
</script>
