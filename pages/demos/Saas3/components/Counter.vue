<template>
  <section class="pb-0">
    <b-container>
      <b-row class="g-4">
        <b-col xl="7" class="position-relative pe-xl-4 order-2">
          ...
          <figure class="position-absolute end-0 bottom-0 me-8 rtl:-scale-x-100">
            <svg
              width="120.4px"
              height="124.5px"
          ...
          <b-row class="position-relative">
            <b-col sm="6" xl="5" class="mt-auto">
              <img :src="decoration5" class="d-none d-sm-block" alt="Decoration-img" />
            </b-col>
            <b-col sm="6">
              <img :src="about14" class="shadow rounded-4" alt="About-img" />
            </b-col>
          </b-row>

          <b-row class="mt-4 position-relative">
            <b-col cols="7" class="mt-auto">
              <img :src="decorationImg" class="shadow rounded-4" alt="Decoration-img" />
            </b-col>
            <b-col cols="5" xl="4">
              <img :src="decoration6" class="shadow rounded-4" alt="Decoration-img" />
            </b-col>
          </b-row>
        </b-col>

        <b-col xl="5" class="order-1 order-xl-2 ms-auto">
          <h2 class="mb-4 mb-xl-5">ببینید چگونه میزل می‌تواند به کسب‌وکار شما کمک کند</h2>
          <p class="mb-4 mb-xl-5">
            با سابقه‌ای از موفقیت، ما اینجا هستیم تا شما را در مسیر دیجیتال که به طور مداوم در حال تحول است، راهنمایی کنیم.
          </p>

          <b-row class="row-cols-1 row-cols-sm-2 g-4 align-items-center">
                ...
                <div class="d-flex">
                  <h4 class="purecounter mb-0">
                    <Vue3autocounter
                      ...
                      :duration="3"
                    />
                    <span class="h4 text-primary mb-0">{{ item.suffix }}</span>
                  </h4>
                </div>
          ...
          <div class="d-flex align-items-sm-center">
            ...
            <div class="ms-3">
              <p class="fs-6 fw-normal heading-color mb-4">
                "ما معتقدیم که ارائه یک محصول عالی نیاز به افراد بزرگ دارد"
              </p>
              <div class="blockquote-footer mb-0">توسط کارولین اورتیز</div>
            </div>
          </div>
        </b-col>
      </b-row>
...
import { statData } from '@/views/demos/Saas3/data'
