  ...
  <section>
    <b-container>
      <div class="inner-container-small text-center">
        <figure class="mb-4 rtl:-scale-x-100">
          <svg
            width="223.6px"
            height="87.2px"
          ...
          >
            ...
            />
            <polygon class="fill-primary" points="65.3,39 61,56.8 0.7,0.7" />
            <path
              class="fill-mode"
            ...
            />
            <polygon class="fill-primary" points="56.5,42.4 61,56.8 0.7,0.8" />
            <path
              class="fill-mode"
            ...
            />
            <polygon class="fill-primary" points="0.7,0.7 91.5,28.5 65.2,38.8 			" />
            <path
              class="fill-mode"
            ...
            />
            <polygon class="fill-primary" points="56.3,42.4 26.5,57.6 0.7,0.7 			" />
            <path
              class="fill-mode"
        ...
        <p>اخبار را دریافت کنید، به‌روز بمانید و از پیشنهادات ویژه بهره‌مند شوید</p>

        <div class="position-relative mt-5">
          <figure class="position-absolute top-100 start-100 translate-middle d-none d-lg-block rtl:-scale-x-100">
            <svg
              class="opacity-1"
              width="148"
              height="140"
          ...
          <div class="bg-light border rounded-2 position-relative z-index-2 p-2 mb-2">
            <b-form class="input-group">
              ...
              />
              <b-button type="button" variant="dark" size="lg" class="rounded-2 mb-0"
                >هم‌اکنون اشتراک شوید!</b-button
              >
            </b-form>
          </div>
        </div>
        <p class="small mb-0 px-4">
          اکنون اشتراک‌گذاری کنید و خبرنامه هفتگی با مطالب آموزشی، دوره‌های جدید، پست‌های جالب، کتاب‌های محبوب و بسیاری موارد دیگر را دریافت کنید.
        </p>
      </div>
    </b-container>
  </section>
