  ...
  <section class="pb-0 overflow-hidden">
    <b-container>
      <div class="inner-container-small text-center mb-4 mb-sm-6">
        <span class="text-primary fw-bold text-uppercase">چگونه کار می‌کند</span>
        <h2 class="mb-0 mt-3">پتانسیل آژانس خود را آزاد کنید</h2>
      </div>

      <b-row>
        <b-col xl="10" class="mx-auto">
          <b-row class="flex-lg-nowrap align-items-center position-relative mb-8">
            <figure class="position-absolute top-100 start-50 mt-n3">
              <svg
                class="rtl:-scale-x-100"
                width="108.7px"
                height="116.7px"
                viewBox="0 0 108.7 116.7"
                style="enable-background: new 0 0 108.7 116.7"
                xml:space="preserve"
              >
                <path
                  class="fill-mode opacity-5"
            ...
            <b-col lg="7">
              <div class="bg-light rounded px-5 ps-md-6 py-7 pe-md-8">
                <div class="icon-lg bg-body rounded-circle fw-bold heading-color mb-3">01</div>
                <h4 class="mb-4">حساب کاربری خود را ایجاد کنید و کار خود را شروع کنید</h4>
                <p class="mb-4">
                  برخی از ایده‌های محصول به‌راحتی پیدا می‌شوند، در حالی که برخی دیگر نیاز به تلاش برای پیدا کردن دارند.
                </p>
                ...
                <a class="btn btn-dark icon-link icon-link-hover" href="#"
                  >همین حالا شروع کنید
            ...
            <b-col cols="11" lg="7" class="ms-lg-n8 mx-auto mt-n5 mt-lg-0">
              <div class="bg-primary bg-opacity-50 rounded p-5 overflow-hidden ms-3">
                <img :src="decoration4" alt="decoration" />
              </div>
            </b-col>
          </b-row>

          <b-row class="flex-lg-nowrap align-items-center position-relative mb-8">
            <figure class="position-absolute top-100 start-50 mt-n3 ms-n8">
              <svg
                  class="rtl:-scale-x-100"
                width="131px"
                height="111.9px"
                viewBox="0 0 131 111.9"
                style="enable-background: new 0 0 131 111.9"
                xml:space="preserve"
              >
                <path
                  class="fill-mode opacity-4"
            ...
            <b-col
              cols="11"
              lg="7"
              class="me-lg-n8 mx-auto mt-n5 mt-lg-0 z-index-2 position-relative order-2"
            >
              <b-card no-body class="shadow rounded p-5 overflow-hidden me-3">
                <img :src="decoration2" class="" alt="decoration" />
              </b-card>
            </b-col>

            <b-col lg="7" class="order-1 order-lg-2">
              <div class="bg-light rounded py-7 px-5 pe-md-6 ps-md-8">
                <div class="icon-lg bg-body rounded-circle fw-bold heading-color mb-3">02</div>
                <h4 class="mb-4">کد را نصب کنید تا کارها را سازماندهی کنید</h4>
                <p class="mb-4">با نصب کد اسنیپت ما، کارایی جریان کار خود را بهبود ببخشید.</p>

                <b-row class="row-cols-2 g-4 mb-5">
                  <b-col>
                    <div class="d-flex">
                      <h4 class="purecounter mb-0">
                        <Vue3autocounter
                          ref="counter"
                          :startAmount="0"
                          :endAmount="150"
                    ...
                    <p class="mb-0 heading-color">نظرات مثبت کاربران</p>
                  </b-col>

                  <b-col>
                    <div class="d-flex">
                      <h4
                        class="purecounter mb-0"
                    ...
                    <p class="mb-0 heading-color">مشتریان خوشحال</p>
                  </b-col>
                </b-row>

                <a class="btn btn-dark icon-link icon-link-hover" href="#"
                  >همین حالا کد را نصب کنید
                  <BIconArrowRight class="bi rtl:-scale-x-100" />
                </a>
              </div>
            </b-col>
          ...
          <b-row class="flex-lg-nowrap align-items-center">
            <b-col lg="7">
              <div class="bg-light rounded px-5 ps-md-6 py-7 pe-md-8">
                <div class="icon-lg bg-body rounded-circle fw-bold heading-color mb-3">03</div>
                <h4 class="mb-3">راهنمای رایگان اتوماسیون بازاریابی را دریافت کنید</h4>
                <p>قدرت اتوماسیون بازاریابی را با راهنمای رایگان ما آزاد کنید.</p>

                <ul class="list-group list-group-borderless mb-4">
                  <li class="list-group-item d-flex">
                    <div
                      class="icon-md flex-centered flex-shrink-0 text-white bg-primary rounded-circle"
                    >
                      <BIconDisplay class="fa-xl" />
                    </div>
                    <div class="ms-3">
                      <p class="heading-color fw-bold mb-0">گزارش‌های روزانه</p>
                      <small>هر روز یک گزارش به صندوق ورودی خود دریافت کنید.</small>
                    </div>
                  </li>
                  ...
                  <li class="list-group-item d-flex mb-0">
                    <div
                      class="icon-md flex-centered flex-shrink-0 text-white bg-primary rounded-circle"
                    >
                      <BIconPhone class="fa-xl" />
                    </div>
                    <div class="ms-3">
                      <p class="heading-color fw-bold mb-0">گزارش‌های موبایل</p>
                      <small>گزارش‌ها را در گوشی یا تبلت خود مرور کنید</small>
                    </div>
                  </li>
                </ul>

                <a class="btn btn-dark icon-link icon-link-hover" href="#"
                  >راهنمای خود را دانلود کنید
                  <BIconArrowRight class="bi rtl:-scale-x-100" />
                </a>
              </div>
            </b-col>
            ...
            <b-col cols="11" lg="7" class="ms-lg-n8 mx-auto mt-n5 mt-lg-0">
              <div class="bg-dark rounded p-5 overflow-hidden ms-3">
                <img :src="decoration3" class="" alt="decoration" />
              </div>
            </b-col>
          </b-row>
        </b-col>
...
import { BIconPatchCheck, BIconArrowRight, BIconPhone, BIconDisplay } from 'bootstrap-icons-vue'
