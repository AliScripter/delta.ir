<template>
  <section class="overflow-hidden">
    <b-container>
      <b-row class="g-4">
        <b-col lg="6" class="mb-sm-6 mb-lg-0">
          <h2 class="mb-4">جریان کار واضح‌تر و سازمان‌یافته‌تر می‌شود</h2>
          <p class="mb-0">
            مفروض بر این است که صبحانه را به خوبی حل کنید. از من تپه‌ای کشید. دره توسط بیست مستقیم به من رسید.
          </p>

          <hr class="my-4 my-sm-5" />

          <b-row class="g-4 mb-4 mb-sm-5">
            <b-col sm="6">
              <div class="d-flex mb-4 mb-sm-5">
                <div
                  class="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle flex-centered"
                >
                  <BIconDiagram3 class="fa-xl" />
                </div>
                <div class="ms-3">
                  <h6 class="mb-0 mb-sm-2">داده‌های خود را سازماندهی کنید</h6>
                  <p class="mb-0">ما سرور ابری خوبی داریم</p>
                </div>
              </div>
              ...
              <div class="d-flex">
                <div
                  class="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle flex-centered"
                >
                  <BIconBoxes class="fa-xl" />
                </div>
                <div class="ms-3">
                  <h6 class="mb-0 mb-sm-2">تحلیل‌های جاسازی شده</h6>
                  <p class="mb-0">یک‌بار پرداخت برای استفاده همیشگی</p>
                </div>
              </div>
            </b-col>
            ...
            <b-col sm="6">
              <div class="d-flex mb-4 mb-sm-5">
                <div
                  class="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle flex-centered"
                >
                  <BIconPeople class="fa-xl" />
                </div>
                <div class="ms-3">
                  <h6 class="mb-0 mb-sm-2">با هر تیمی کار کنید</h6>
                  <p class="mb-0">آماده برای کمک به کارمند شما</p>
                </div>
              </div>
              ...
              <div class="d-flex">
                <div
                  class="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle flex-centered"
                >
                  <BIconShieldCheck class="fa-xl" />
                </div>
                <div class="ms-3">
                  <h6 class="mb-0 mb-sm-2">همکاری امن</h6>
                  <p class="mb-0">به اشتراک بگذارید و رکورد خود را منتشر کنید.</p>
                </div>
              </div>
            </b-col>
          </b-row>

          <router-link :to="{ name: 'about.v2' }" class="btn btn-dark mb-0"
            >اطلاعات بیشتر را بدانید</router-link
          >
        </b-col>

        <b-col lg="6">
          <b-row>
            <b-col lg="11" xl="9" class="position-relative ms-auto">
              <figure class="position-absolute top-50 start-0 translate-middle z-index-2 rtl:-scale-x-100">
                <svg
                  width="159"
                  height="155"
                  viewBox="0 0 159 155"
              ...
              <figure
                class="position-absolute top-0 start-100 translate-middle mt-8 ms-5 d-none d-xl-block rtl:-scale-x-100"
              >
                <svg
                  class="fill-mode"
                  width="96"
              ...
              <b-card no-body class="border p-4">
                <h6>پروژه اخیر</h6>
                <img :src="about7" class="card-img mb-3" alt="card img" />
                <h6>طراحی تم وب‌فلو چندمنظوره SaaS</h6>
                <ul class="nav nav-divider mb-2 mb-sm-3">
                  <li class="nav-item">سه‌شنبه، 28 دی</li>
                  <li class="nav-item">11:30 ب.ظ</li>
                </ul>
                <div class="d-flex align-items-center mb-3">
                  ...
                  <div class="ms-2">
                    <small class="mb-0 fw-bold">اما واتسون</small>
                  </div>
                </div>
                <a href="#" class="btn btn-dark-soft mb-0">مشاهده مطالعه موردی</a>
              </b-card>

              <div
                class="bg-body rounded-4 shadow d-flex align-items-center position-absolute top-0 end-0 d-none d-sm-flex mt-n5 me-xl-n6 p-3"
              >
                <div class="avatar">
                  <img class="avatar-img rounded-circle" :src="avatar5" alt="avatar" />
                </div>
                <div class="mx-3">
                  <h6 class="mb-0">افزایش فالوورها</h6>
                  <small>از 7 روز گذشته</small>
                </div>
                <div class="badge bg-primary">24.7%</div>
              </div>

              <ul
                class="list-inline bg-body d-flex flex-column rounded shadow position-absolute top-0 start-0 d-none d-sm-flex p-2 mb-0 mt-3 ms-xl-n5"
              >
                ...
                <li class="list-inline-item me-0">
                  <a class="btn btn-xs btn-icon bg-twitter" href="#"
                ...
                <li class="list-inline-item me-0">
                  <a class="btn btn-xs btn-icon bg-youtube" href="#"
...
import { BIconDiagram3, BIconBoxes, BIconPeople, BIconShieldCheck } from 'bootstrap-icons-vue'
