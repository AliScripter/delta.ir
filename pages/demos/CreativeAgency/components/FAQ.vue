    ...
    <b-container class="mt-9">
      <b-row class="align-items-start">
        <b-col md="6" xl="5" class="position-relative">
          <figure class="position-absolute top-0 start-0 mt-n6 ms-n5 rtl:-scale-x-100">
            <svg
              width="117"
              height="98"
              viewBox="0 0 117 98"
          ...
          <img :src="about5" class="rounded" alt="about-img" />
        </b-col>

        <b-col md="6" class="position-relative ms-auto mt-5 mt-md-0">
          <h2 class="mb-4 mb-md-5">بررسی ویژگی‌های اساسی پلتفرم</h2>
          <b-accordion
            class="accordion-icon accordion-icon-start accordion-bg-light"
            id="accordionFaq"
          >
            <b-accordion-item
              bodyClass="mt-3 pb-0"
              ...
              :title="faq.question"
              button-class="fw-semibold rounded ps-6"
            >
              {{ faq.answer }}
            </b-accordion-item>
          </b-accordion>
...
import AOS from 'aos'
import { faqData } from '@/views/demos/CreativeAgency/data'
