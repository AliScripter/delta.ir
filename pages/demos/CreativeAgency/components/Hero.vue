        ...
        <b-col xl="6">
          <h1 class="mb-0 lh-base">
            ...
            <span class="position-relative"
              >واقعیت‌های
              <span
                class="position-absolute top-50 start-50 translate-middle z-index-n1 ms-n2 d-none d-sm-block rtl:-scale-x-100"
              >
                <svg
                  width="182"
                  height="53"
          ...
          <p class="mb-0 mt-4 mt-xl-5">
            ایده‌های شما نیروی محرکه پشت کسب‌وکار شما هستند و آژانس دیجیتال ما اینجاست تا آن ایده‌ها را به واقعیت‌های دیجیتال ملموس تبدیل کند.
          </p>

          <div class="d-flex gap-1 gap-sm-3 flex-wrap mt-4 mt-xl-5">
            <b-button variant="dark" type="button">شروع کنید</b-button>
            <b-button variant="outline-dark" type="button">شروع دوره آزمایشی 14 روزه</b-button>
          </div>

          <ul class="list-inline d-flex flex-wrap gap-2 gap-sm-4 mb-0 mt-4 mt-xl-5">
            <li class="list-inline-item heading-color icons-center">
              <BIconStopwatch class="me-1" />
              پشتیبانی 24/7
            </li>
            <li class="list-inline-item heading-color icons-center">
              <BIconFire class="me-1" />
              به‌روزرسانی‌های رایگان
            </li>
            <li class="list-inline-item heading-color icons-center">
              <BIconLifePreserver class="me-1" />
              دسترسی به اسناد ممتاز
            </li>
          </ul>
        </b-col>

        <b-col xl="6" class="text-center rtl:-scale-x-100">
          <img :src="heroFinance" alt="hero-img" />
        </b-col>
      </b-row>
      ...
      <b-row>
        <b-col md="6" xl="7" class="mb-5 mb-md-0">
          <p class="mb-0">
            ...
            | ما به فراتر رفتن و عبور از محدودیت‌ها اعتقاد داریم. ما به
            <b class="text-primary fs-6">19k</b> رسیدیم
          </p>
          ...
          >
            <SwiperSlide v-for="(image, idx) in clientImages" :key="idx">
              <a :href="image.href" target="_blank"><img :src="image.img" class="px-3" :class="!idx && 'ps-0'" alt="client-img" /></a>
            </SwiperSlide>
          </Swiper>
        </b-col>

        <b-col md="6" lg="5" xl="3" class="ms-auto text-md-end">
          <p class="mb-0 me-2">اعتماد شده توسط مشتریان <span class="badge bg-dark">فعال</span></p>
          ...
          <div class="d-flex justify-content-md-end mt-2 mt-md-4">
            ...
            <div>
              <div class="d-flex justify-content-md-end">
                <h4 class="purecounter mb-0">
                  <Vue3autocounter ref="counter" :startAmount="0" :endAmount="56" :duration="3" />
                </h4>
                <span class="h4 mb-0">+</span>
              </div>
              <p class="mb-0">پروژه‌های تکمیل شده</p>
            </div>
          </div>
        </b-col>
      </b-row>
