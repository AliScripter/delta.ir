  ...
  <section>
    <b-container>
      <div class="bg-light rounded position-relative overflow-hidden p-4 p-sm-6">
        ...
        <b-row class="g-4">
          <b-col lg="5">
            <h2 class="mb-4">هر کجا، هر زمان، هر پلتفرم</h2>
            <p class="mb-4">
              فرض کنید که برای حل مشکلات صبحانه، به طور کامل یا به درستی. این من را به سمت تپه‌ای کشاند. دره به سوی بیست به طور مستقیم به من هدایت کرد.
            </p>
