  ...
  <section class="pb-0">
    <b-container>
      <div class="inner-container text-center mb-4 mb-sm-6">
        <h2 class="mb-4">جزئیات فنی</h2>
        <p class="mb-0">
          کیفیت صدای AirPods چشمگیر است. آنها عملکرد صوتی غنی، واضح و متعادل را ارائه می‌دهند که آنها را برای گوش دادن به موسیقی، تماشای فیلم‌ها یا برقراری تماس‌ها ایده‌آل می‌سازد.
        </p>
      </div>

      <b-row class="g-4 align-items-center">
        <b-col lg="4" class="order-1">
          <div class="d-flex justify-content-lg-end mb-4 mb-lg-8">
            <div class="text-lg-end order-1 ms-3 ms-lg-0 me-lg-3">
              <h6 class="mb-1">مشخصات صوتی</h6>
              <small
                >(سفارشی با محدوده بالا، لغو نویز، شفافیت تطبیقی، تنظیمات تطبیقی)</small
              >
            </div>
            <div
              class="icon-lg bg-light heading-color rounded flex-shrink-0 order-lg-2 flex-centered"
            >
              <BIconVolumeUp style="height: 29px; width: 29px" class="fa-xl" />
            </div>
          </div>

          <div class="d-flex justify-content-lg-end mb-4 mb-lg-8 me-5">
            <div class="text-lg-end order-1 ms-3 ms-lg-0 me-lg-3">
              <h6 class="mb-1">ابعاد فیزیکی</h6>
              <small
                >ارتفاع: ۱.۷۸ اینچ، عرض: ۲.۳۹ اینچ، عمق: ۰.۸۵ اینچ، وزن: ۱.۷۹ اونس</small
              >
            </div>
            <div
              class="icon-lg bg-light heading-color rounded flex-shrink-0 order-lg-2 flex-centered"
            >
              <BIconRulers style="height: 29px; width: 29px" class="fa-xl" />
            </div>
          </div>

          <div class="d-flex justify-content-lg-end">
            <div class="text-lg-end order-1 ms-3 ms-lg-0 me-lg-3">
              <h6 class="mb-1">صدای فراگیر</h6>
              <small>صوت فضایی شخصی‌سازی شده با ردیابی حرکات سر</small>
            </div>
            <div
              class="icon-lg bg-light heading-color rounded flex-shrink-0 order-lg-2 flex-centered"
            >
              <BIconSoundwave style="height: 29px; width: 29px" class="fa-xl" />
            </div>
          </div>
        </b-col>

        <b-col md="7" lg="4" class="mx-auto position-relative order-lg-2">
          <img :src="product2" class="px-4 z-index-1 position-relative" alt="Technical-img" />
        ...
        <b-col lg="4" class="order-3">
          <div class="d-flex mb-4 mb-lg-8">
            <div class="icon-lg bg-light heading-color rounded flex-shrink-0 flex-centered">
              <BIconBoxSeam style="height: 29px; width: 29px" class="fa-xl" />
            </div>
            <div class="ms-3">
              <h6 class="mb-1">محتویات جعبه</h6>
              <small>AirPods Pro، کیس شارژ، کابل USB-C، مستندات</small>
            </div>
          </div>

          <div class="d-flex mb-4 mb-lg-8 ms-lg-5">
            <div class="icon-lg bg-light heading-color rounded flex-shrink-0 flex-centered">
              <BIconBatteryCharging style="height: 29px; width: 29px" class="fa-xl" />
            </div>
            <div class="ms-3">
              <h6 class="mb-1">بهترین عمر باتری</h6>
              <small>تا ۳۰ ساعت زمان گوش دادن، تا ۲۴ ساعت زمان مکالمه</small>
            </div>
          </div>

          <div class="d-flex">
            <div class="icon-lg bg-light heading-color rounded flex-shrink-0 flex-centered">
              <BIconFingerprint style="height: 29px; width: 29px" class="fa-xl" />
            </div>
            <div class="ms-3">
              <h6 class="mb-1">حسگرها</h6>
              <small>میکروفون‌های دوگانه، حسگر تشخیص پوست، کنترل لمسی</small>
            </div>
          </div>
        </b-col>
      </b-row>
