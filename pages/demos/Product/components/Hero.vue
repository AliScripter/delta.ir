<template>
  <section class="bg-light position-relative overflow-hidden">
    ...
    <b-container class="position-relative pt-5">
      <b-row>
        <b-col lg="7" class="mb-6 mb-lg-0">
          <h1 class="display-4 lh-base mb-4">جادوی که هرگز نشنیده‌اید</h1>
          <p class="mb-4">
            به صفحه فرود AirPods ما خوش آمدید! در اینجا، شما همه چیزهایی که باید
            در مورد هدفون‌های بی‌سیم انقلابی میزل بدانید را کشف خواهید کرد.
          </p>
          <b-button variant="primary" size="lg" class="mb-0">همین حالا خریداری کنید</b-button>
          ...
          <b-row class="g-4 align-items-center">
            ...
            <b-col sm="8">
              <h5 class="mb-3">اکنون با ۴ رنگ جدید و هیجان‌انگیز</h5>
              <p class="heading-color mb-3">
                AirPods همچنین با در نظر گرفتن راحتی طراحی شده‌اند. آنها با اندازه‌های مختلف گوشواره برای مطابقت با
                اشکال و اندازه‌های مختلف گوش ارائه می‌شوند.
              </p>

              <div class="nav nav-tabs nav-tabs-radio border-0" role="tablist">
                <div
                  class="nav-link p-0 me-2"
                  data-bs-toggle="tab"
                  data-bs-target="#white"
                  aria-selected="false"
                  tabindex="-1"
                  role="tab"
                >
        ...
        <b-col sm="10" lg="5" class="position-relative px-5 mx-auto">
          <img :src="heroProduct" alt="hero-img" class="rtl:-scale-x-100" />
          ...
          <div class="position-absolute top-0 start-0">
            <div class="position-relative">
              <button
                id="popover-1"
                type="button"
                class="btn btn-white btn-ripple btn-round text-primary z-index-1 flex-centered"
              >
                <BIconPlusLg />
              </button>
              <figure class="position-absolute top-50 start-50 mt-n1 rtl:-scale-x-100">
                <svg
                  width="249"
                  height="69"
                  viewBox="0 0 249 69"
                ...
                >
                  ...
                  <circle class="fill-primary" cx="244" cy="64" r="5" />
                </svg>
              </figure>
            </div>
          </div>
          ...
          <div class="position-absolute bottom-0 end-0 me-lg-4 me-xl-8 mb-lg-9 mb-xl-7">
            <div class="position-relative">
              <button
                id="popover-2"
                type="button"
                class="btn btn-white btn-ripple btn-round text-primary z-index-1 mb-0 mt-n1 flex-centered"
              >
                <BIconPlusLg />
              </button>
              <figure class="position-absolute bottom-100 end-100 mb-n3 rtl:-scale-x-100">
                <svg
                  width="175"
                  height="90"
                  viewBox="0 0 175 90"
                ...
                >
                  ...
                  <circle class="fill-primary" cx="5" cy="5" r="5" transform="rotate(180 5 5)" />
                </svg>
              </figure>
            </div>
          </div>
          <b-popover
            ...
            click
            content="و اینجا محتوای شگفت‌انگیزی وجود دارد. بسیار جذاب است. درست است؟"
          />
          <b-popover
            target="popover-2"
            :placement="rtl ? 'left' : 'right'"
