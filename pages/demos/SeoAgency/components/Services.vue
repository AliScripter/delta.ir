<template>
  <Section class="pb-0">
    <b-container>
      <b-row class="align-items-center mb-4 mb-md-6">
        <b-col md="6" class="mb-3 mb-md-0">
          <h2 class="mb-0">راه‌حل‌های SEO سفارشی برای کسب‌وکار شما</h2>
        </b-col>

        <b-col md="4" class="ms-auto text-md-end">
          <router-link to="#" class="btn btn-dark mb-0">تمام خدمات را مشاهده کنید</router-link>
        </b-col>
      </b-row>
      ...
      >
        <SwiperSlide>
          <b-card no-body class="bg-primary p-5 mt-lg-7">
            <b-card-header class="bg-transparent d-flex justify-content-between p-0 pb-6">
              <h5 class="me-4 mb-0">
                <a href="#" class="stretched-link heading-color">آموزش و کارگاه‌های SEO</a>
              </h5>
              <router-link
                to="#"
                class="btn btn-round btn-light border flex-shrink-0 flex-centered rtl:-scale-x-100"
              >
                <BIconArrowUpRight />
              </router-link>
            </b-card-header>
            ...
            <b-card-body class="p-0">
              ...
              <span class="text-white">چه مواردی شامل می‌شود:</span>
              <p class="fw-semibold heading-color mb-0 mt-2">
                اصول SEO، تحقیق در مورد کلمات کلیدی، گزارش‌دهی و به‌روزرسانی‌های الگوریتم
              </p>
            </b-card-body>
          </b-card>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <b-card no-body class="bg-dark p-5 mt-lg-4" data-bs-theme="dark">
            <b-card-header class="bg-transparent d-flex justify-content-between p-0 pb-6">
              <h5 class="me-4 mb-0">
                <a href="#" class="stretched-link">بهینه‌سازی SEO موبایل</a>
              </h5>
              <a href="#" class="btn btn-round btn-light border flex-shrink-0 flex-centered rtl:-scale-x-100">
                <BIconArrowUpRight />
              </a>
            </b-card-header>
            ...
            <b-card-body class="p-0">
              ...
              <span>چه مواردی شامل می‌شود:</span>
              <p class="fw-semibold heading-color mb-0 mt-2">
                بهینه‌سازی سرعت صفحه، پاسخگویی موبایل و عوامل قابلیت استفاده
              </p>
            </b-card-body>
          </b-card>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <b-card no-body class="bg-light border p-5">
            <b-card-header class="bg-transparent d-flex justify-content-between p-0 pb-6">
              <h5 class="me-4 mb-0">
                <a href="#" class="stretched-link">استراتژی و تولید محتوا</a>
              </h5>
              <a href="#" class="btn btn-round btn-white border flex-shrink-0 flex-centered rtl:-scale-x-100">
                <BIconArrowUpRight />
              </a>
            </b-card-header>
            ...
            <b-card-body class="p-0">
              ...
              <span>چه مواردی شامل می‌شود:</span>
              <p class="fw-semibold heading-color mb-0 mt-2">
                تحقیق درباره مخاطب، تحلیل کلمات کلیدی، برنامه‌ریزی محتوا، بهینه‌سازی
              </p>
            </b-card-body>
          </b-card>
        </SwiperSlide>
        <div class="swiper-pagination swiper-pagination-primary position-relative mt-4" />
      </Swiper>
    </b-container>
  </Section>
</template>
