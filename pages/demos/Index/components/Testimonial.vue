      ...
      <b-row>
        <b-col lg="6" class="mb-5 mb-lg-0">
          <span class="heading-color bg-light small rounded-3 px-3 py-2"
            >💖 نتایج واقعی از مشتریان واقعی</span
          >
          <h2 class="my-4">ببینید چگونه به مشتریان خود در موفقیت کمک کرده‌ایم</h2>

          <h6 class="mb-0">بیش از ۱۵۰۰ آژانس از میزل استفاده می‌کنند</h6>
        ...
        <b-col sm="10" lg="6" xl="5" class="position-relative ms-xl-auto">
          <img :src="about3" class="rounded" alt="testimonial-img" />

          <figure class="position-absolute top-50 start-0 translate-middle ms-n5 d-none d-xl-block rtl:-scale-x-100">
            <svg
              width="144"
              height="166"
              viewBox="0 0 144 166"
          ...
          <b-col
            cols="11"
            sm="8"
            class="position-absolute top-0 start-0 mt-n2 mt-sm-7 ms-n2 ms-sm-n7"
          >
            <div class="bg-dark rounded d-flex align-items-center px-3 py-2">
              ...
              <p class="text-white small mb-0">بهترین تم بوت‌استرپ که تا به حال استفاده کرده‌ایم 🔥</p>
            </div>
          </b-col>

          <div
            class="bg-white rounded shadow d-flex align-items-center position-absolute bottom-0 start-0 mb-sm-5 ms-sm-n5 px-3 py-2"
          >
            <div class="avatar avatar-sm flex-shrink-0 me-2">
              <img class="avatar-img rounded-circle" :src="avatar3" alt="avatar" />
            </div>
            <p class="text-dark small mb-0">قالب عالی 💗</p>
          </div>
        </b-col>
      </b-row>
    </b-container>
...
import { testimonials } from '@/views/demos/Index/data'
import TestimonialCard from '@/views/demos/Index/components/TestimonialCard.vue'
