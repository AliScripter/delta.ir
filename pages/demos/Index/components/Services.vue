  ...
  <section class="bg-dark position-relative overflow-hidden" data-bs-theme="dark">
    ...
    <b-container class="position-relative">
      <div class="inner-container-small text-center">
        <span class="bg-light heading-color small rounded-3 px-3 py-2"
          >🚀 راه‌حل‌های نوآورانه، نتایج قابل اندازه‌گیری</span
        >
        <h2 class="mb-0 mt-4">ما در خدمات زیر تخصص داریم</h2>
      </div>

      <b-row class="row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 gy-5 gy-md-7 mt-3">
        <b-col v-for="(service, idx) in services" :key="idx">
          <b-card no-body class="bg-light h-100">
            <b-card-body class="pb-0">
              <div class="icon-lg bg-white text-primary rounded-circle mb-4 mt-n5 flex-centered">
                <component :is="service.icon" class="fa-fw fs-5" />
              </div>
              <h5 class="mb-3">
...
import { services } from '@/views/demos/Index/data'
</script>
