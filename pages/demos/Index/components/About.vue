<template>
  <section>
    <b-container>
      <b-row class="g-4 align-items-xl-center">
        <b-col lg="7">
          <b-row class="pe-xl-5">
            <b-col sm="6">
              <img :src="about2" class="rounded" alt="about-img" />
              ...
              <b-row class="mb-4">
                <b-col sm="6" class="mb-4 mb-sm-0">
                  <div class="bg-dark text-white rounded text-center p-3">
                    ...
                    <p class="mb-0">سال تجربه</p>
                  </div>
                </b-col>
                <b-col sm="6">
                  <div class="bg-primary rounded text-center p-3">
                    <span class="h2 text-white">1.2K</span>
                    <p class="mb-0 text-white">مشتریان خوشحال</p>
                  </div>
                </b-col>
              </b-row>

              <img :src="about1" class="rounded" alt="about-img-2" />
            </b-col>
          </b-row>
        </b-col>
        ...
        <b-col lg="5">
          <span class="heading-color bg-light small rounded-3 px-3 py-2"
            >🤝 مسیر موفقیت شما در دنیای دیجیتال از اینجا می‌گذرد</span
          >
          <h2 class="my-4">بازتعریف تجربیات آنلاین برای آیندگان</h2>
          <p class="mb-4">
            به عصر جدیدی از موفقیت دیجیتال با میزل بپیوندید. تیم ما طراحی پیشرفته را با توسعه قوی ترکیب می‌کند تا وب‌سایت‌هایی خلق کند که واقعاً جلب توجه کرده و تبدیل کنند.
          </p>
          <ul class="list-group list-group-borderless mb-4">
            <li class="list-group-item heading-color d-flex mb-0 icons-center">
              <BIconPatchCheckFill class="text-primary me-2" />
              تاکید بر راه‌حل‌های مبتنی بر ROI
            </li>
            <li class="list-group-item heading-color d-flex mb-0 icons-center">
              <BIconPatchCheckFill class="text-primary me-2" />
              تیم متخصص با مهارت‌های متنوع
            </li>
            <li class="list-group-item heading-color d-flex mb-0 icons-center">
              <BIconPatchCheckFill class="text-primary me-2" />
              سابقه اثبات‌شده در ارائه نتایج
            </li>
          </ul>
          <router-link :to="{ name: 'about.v1' }" class="btn btn-dark mb-0"
            >بیشتر کشف کنید</router-link
          >
        </b-col>
      </b-row>
    </b-container>
