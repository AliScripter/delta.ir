<template>
  <section class="position-relative overflow-hidden pb-0 pt-xl-9">
    <div class="position-absolute top-0 start-0 ms-n7 d-none d-xl-block rtl:-scale-x-100">
      <img :src="patternSvg" alt="" />
    </div>

    <figure class="position-absolute top-0 end-0 me-n4 mt-n7 d-none d-xl-block rtl:-scale-x-100">
      <svg
        class="fill-mode opacity-1"
        width="775px"
        height="834px"
        viewBox="0 0 775 834"
        style="enable-background: new 0 0 775 834"
        xml:space="preserve"
      >
        <path
    ...
    <b-container class="pt-4 pt-sm-5">
      <b-row class="g-xl-5">
        <b-col xl="7" class="mb-5 mb-xl-0">
          <div class="pe-xxl-4">
            <span class="heading-color d-inline-block bg-light small rounded-3 px-3 py-2"
              >🤩 خدمات دیجیتال برنده جایزه</span
            >

            <h1 class="mt-3 lh-base">
              آژانس تبلیغاتی خلاق و متخصص در
              <span
                class="cd-headline clip big-clip is-full-width text-primary mb-0 d-block d-xxl-inline-block"
              >
                <ITyped id="type1" :strings="strings" />
              </span>
            </h1>
            <p class="mb-0 mt-4 mt-md-5">
              از مفهوم تا اجرا، ما طراحی‌های وبی را ارائه می‌دهیم که تأثیرگذار است. بگذارید برند شما با وب‌سایت‌های نوآورانه و بصری خیره‌کننده ما درخشان شود.
            </p>
            ...
            <b-row class="mt-5">
              <b-col md="6" class="mb-5 mb-md-0">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-3">
                    ...
                    <p class="mb-0">ما همیشه برای کمک در دسترس هستیم</p>
                  </div>
                </div>
              </b-col>
              ...
              <b-col md="6">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-3">
                    <h6 class="mb-1">آژانس برنده جایزه</h6>
                    <p class="mb-0">شما در دستان امنی هستید</p>
                  </div>
                </div>
              </b-col>
            </b-row>
        ...
        <b-col md="10" xl="5" class="position-relative mx-auto mt-7 mt-xl-0">
          <figure class="position-absolute top-0 start-0 translate-middle mt-2 rtl:-scale-x-100">
            <svg
              width="124.2px"
              height="76.9px"
              viewBox="0 0 124.2 76.9"
              style="enable-background: new 0 0 124.2 76.9"
              xml:space="preserve"
            >
              <path
                class="fill-mode"
          ...
          <img :src="backgroundImg1" class="rounded" alt="hero-img" />
          ...
          >
            ...
            <p class="text-white mb-0 mt-2">کل بازدیدکنندگان در ماه</p>
          </div>

          <b-card
            no-body
            class="d-inline-block shadow rounded-4 position-absolute end-0 top-0 p-3 me-lg-n3 me-xxl-n7 mt-n5 d-none d-sm-block"
          >
            <img :src="trustpilot" class="light-mode-item h-20px mb-2" alt="Client-img" />
            <img :src="trustpilotLight" class="dark-mode-item h-20px mb-2" alt="Client-img" />
            <div class="d-flex align-items-center">
              <img :src="trustpilotStar" class="h-30px" alt="rating-img" />
              <h6 class="font-base fw-bold ms-1 mb-0">4.8/5.0</h6>
            </div>
            <p class="small mb-0 mt-2">بررسی شده توسط 365 کاربر</p>
          </b-card>
        </b-col>
      </b-row>
    </b-container>
...
const trustpilot = lang === 'fa' ? trustpilotImgFA : trustpilotImgEN;
const trustpilotLight = lang === 'fa' ? trustpilotLightImgFA : trustpilotLightImgEN;

const strings = ['طراحی وب', 'برندینگ', 'تیزر تبلیغاتی']
