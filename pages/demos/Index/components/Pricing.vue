    ...
    <b-container>
      <div class="inner-container text-center mb-4 mb-sm-6">
        <span class="heading-color bg-light small rounded-3 px-3 py-2"
          >💵 بسته‌های قیمت‌گذاری شفاف</span
        >
        <h2 class="mb-0 mt-4">برنامه‌ای دریافت کنید که با شما رشد کند</h2>
      </div>

      <b-row>
        <b-col lg="8">
          <b-card class="bg-transparent h-100 px-0">
            <b-row class="text-center text-sm-start">
              <b-col sm="6">
                  ...
                  <div>
                    <figure>
                      <svg
                        ...
                        height="156px"
                        viewBox="0 0 120 156"
                        style="enable-background: new 0 0 120 156"
                        xml:space="preserve"
                      >
                        <path
                          class="fill-primary"
                    ...
                    <div class="badge bg-dark text-white mb-3">حالت رئیس</div>
                    <h6 class="mb-3">
                      <span v-if="lang==='en'"><span class="display-2">{{ currency }}59</span> /ماهیانه</span>
                      <span v-else-if="lang==='fa'"><span class="display-2">59 <small class="fs-3">{{ currency }}</small></span> /ماهیانه</span>
                    </h6>
                    <p class="mb-0">
                      راه‌حل همه‌جانبه برای کسب‌وکارهایی که می‌خواهند آنلاین موفق شوند.
                    </p>
                  </div>
              ...
              <b-col sm="6" class="ps-md-5">
                <h6 class="mb-sm-4">لیست ویژگی‌های مورد نیاز شما</h6>
                <ul class="list-group list-group-borderless mb-3 mb-sm-4">
                  <li
                    v-for="(feature, idx) in features"
                    :key="idx"
                    class="list-group-item heading-color mb-0 gap-1"
                  >
                    <BIconCheckLg class="text-primary mb-1" />
                    {{ feature }}
                  </li>
                </ul>
                <b-button variant="dark">آغاز دوره آزمایشی 7 روزه رایگان</b-button>
                <p class="mb-0">نیاز به کارت اعتباری نیست!</p>
              </b-col>
            </b-row>
          </b-card>
        </b-col>

        <b-col lg="4" class="ms-auto mt-4 mt-lg-0">
          <PricingCard />
        </b-col>
      </b-row>
    </b-container>
...
import PricingCard from '@/views/demos/Index/components/PricingCard.vue'

const lang: string | undefined = inject('lang')

const features = [
  'تا 5 کاربر در ماه',
  '۵ میزبان و دامنه رایگان',
  'ویرایشگرهای سبک گوگل اسناد',
  'پشتیبانی از بیش از ۳۰ زبان',
  'صفحات فرود و ویجت‌های وب',
