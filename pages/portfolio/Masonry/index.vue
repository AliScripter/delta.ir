      ...
      <b-container>
          ...
          <div class="d-flex justify-content-center position-relative z-index-9">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-dots breadcrumb-dark mb-1">
                ...
                <li class="breadcrumb-item active" aria-current="page">نمونه کارهای میسونری</li>
              </ol>
            </nav>
          </div>
          <h1 class="h2 text-white">نمونه کارهای میسونری</h1>
        </div>

        <div class="d-lg-flex align-items-center justify-content-center mt-6">
          <h6 class="mb-lg-0 me-3">مرور بر اساس:</h6>
          <div class="grid-menu" data-target=".filter-container">
            <ul class="nav nav-pills nav-pills-primary-soft gap-2">
              <li class="nav-item">
                <a class="nav-link active" data-filter="*">تمامی کارها</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-filter=".marketing">بازاریابی</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-filter=".design">طراحی وب</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-filter=".business">توسعه</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-filter=".brand">طراحی برند</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-filter=".ui">طراحی UI/UX</a>
              </li>
            </ul>
          </div>
        </div>

        <b-row class="g-4 filter-container mt-3" data-isotope='{"layoutMode": "masonry", "originLeft": false}'>
          <b-col
            sm="6"
            lg="4"
            class="grid-item"
            :class="portfolio.categoryClass"
            v-for="(portfolio, idx) in portfolioData"
            :key="idx"
          >
        ...
        <div class="text-center mt-7">
          <b-button size="lg" variant="outline-light" class="mb-0"
            ><font-awesome-icon :icon="faSpinner" class="fa-lg me-2" />بارگذاری کارهای بیشتر</b-button
          >
        </div>
      </b-container>
    </section>
...
import TopNavigationBar9 from '@/views/portfolio/Masonry/components/TopNavigationBar9.vue'
import { portfolioData } from '@/views/portfolio/Masonry/data'
import { onMounted } from 'vue'
import { faSpinner } from '@fortawesome/free-solid-svg-icons'
import { initIsotope } from '@/helpers/init-isotope'
import PortfolioCard from '@/views/portfolio/Masonry/components/PortfolioCard.vue'
import Footer8 from '@/views/portfolio/Masonry/components/Footer8.vue'
