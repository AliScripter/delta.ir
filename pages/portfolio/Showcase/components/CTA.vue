  ...
  <section class="position-relative z-index-2 py-0 mb-n7">
    <b-container class="position-relative">
      <div class="bg-primary rounded position-relative overflow-hidden p-4 p-sm-5">
        <figure class="position-absolute top-0 start-0 ms-n8 rtl:-scale-x-100">
          <svg
            width="371"
            height="354"
            viewBox="0 0 371 354"
        ...
        <b-row class="g-4 position-relative">
          <b-col lg="7" class="mx-auto text-center">
            <h2 class="text-white mb-4">بیایید با هم کار کنیم</h2>
            <p class="text-white mb-4">
              من وقت می‌گذارم تا چشم‌انداز و اهداف شما را درک کنم و با شما کار کنم تا برنامه‌ای سفارشی برای کمک به موفقیت شما تهیه کنم.
            </p>
            <div class="d-flex justify-content-center align-items-center gap-1 gap-sm-2">
              <router-link :to="{ name: 'contact.v1' }" class="btn btn-dark icons-center"
                ><BIconEnvelope class="me-2" />به ما ایمیل بزنید</router-link
              >
              <router-link :to="{ name: 'contact.v2' }" class="btn btn-dark icons-center"
                ><BIconTelephone class="me-2" />تماس با ما</router-link
              >
            </div>
          </b-col>
        </b-row>
