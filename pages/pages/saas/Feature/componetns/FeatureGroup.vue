  ...
  <section class="pt-0">
    <b-container>
      <div class="inner-container-small text-center mb-4 mb-sm-5">
        <h2 class="mb-4">توانمندسازی کسب‌وکار شما با ابزارهای پیشرفته</h2>
        <p class="mb-0">
          هیچ چیزی نمی‌تواند شما را از رسیدن به آنچه که می‌خواهید متوقف کند، به جز خودتان. اگر به آن اختصاص دهید، به هدف خود خواهید رسید.
        </p>
      </div>

      <b-row class="g-4 g-lg-6">
        <b-col xl="4">
          <b-card no-body class="d-flex p-4 border h-100 flex-md-row flex-xl-column">
            <div class="me-md-5 me-xl-0 mb-4 mb-md-0">
              ...
              <b-card-title tag="h5" class="mb-3">تخصص در پیاده‌سازی SaaS</b-card-title>
              <p class="mb-3">
                پلتفرم ما مجموعه‌ای جامع از ویژگی‌ها را ارائه می‌دهد که برای توانمندسازی کسب‌وکار شما طراحی شده است.
              </p>
              <a href="#" class="btn btn-dark mb-0">مشاهده ادغام</a>
            </div>
            <div class="mt-auto p-0">
              <img :src="integrationImg" alt="feature-img" />
            </div>
          </b-card>
        </b-col>
        ...
        <b-col xl="8">
          <b-row class="g-4 g-lg-6">
            <b-col cols="12">
              <b-card no-body class="bg-primary bg-opacity-10 overflow-hidden p-5 pb-0">
                <b-row class="g-4">
                  <b-col md="6">
                    <b-card-body class="p-0">
                      ...
                      <b-card-title tag="h5" class="mb-3"
                        >همکاری در کار نباید اینقدر سخت باشد</b-card-title
                      >
                      <p class="mb-3">
                        ما راه‌حل‌های تحول دیجیتال را ارائه می‌دهیم که به شرکت‌ها اجازه می‌دهد تا رویاهای خود را به واقعیت تبدیل کنند.
                      </p>
                      <a href="#" class="btn btn-outline-primary mb-5">اکنون کاوش کنید</a>
                    </b-card-body>
                  </b-col>
                  ...
                  <b-col md="6">
                    <div class="me-n9 mb-n6">
                      <img
                        :src="featureImg"
                        class="card-img border border-dark border-5"
                        alt="feature-img"
                      />
                    </div>
                  </b-col>
            ...
            <b-col lg="6">
              <b-card no-body class="bg-dark rounded h-100 overflow-hidden p-5">
                <figure class="position-absolute bottom-0 end-0 mb-n4 me-n5 rtl:-scale-x-100">
                  <svg
                    class="fill-white opacity-1"
                    width="220px"
                    height="209px"
                    viewBox="0 0 220 209"
                ...
                <b-card-body class="bg-transparent p-0">
                  <h5 class="text-white mb-0">می‌خواهید ببینید چگونه می‌توان این را در پروژه‌ها پیاده کرد؟</h5>
                </b-card-body>

                <b-card-footer class="bg-transparent p-0 mt-6">
                  <router-link :to="{ name: 'portfolio.list' }" class="btn btn-white mb-0"
                    >کارهای ما را ببینید</router-link
                  >
                </b-card-footer>
              </b-card>
            </b-col>
            ...
            <b-col lg="6">
              <b-card no-body class="bg-light rounded h-100 overflow-hidden p-4">
                <b-card-body class="bg-transparent p-0">
                  ...
                  <h5 class="mb-3">حفاظت از داده‌ها</h5>
                  <p class="mb-0">
                    سفارش کافی آماده است. زمان‌بندی شده و حالا آن‌ها باید اغلب تنظیم شوند.
                  </p>
                </b-card-body>
