  ...
  <section class="bg-dark position-relative overflow-hidden" data-bs-theme="dark">
    <b-container class="position-relative">
      <b-row class="align-items-start">
        <b-col lg="6" xl="5" class="position-relative text-center order-1 mt-6 mt-lg-0">
          ...
          <figure class="position-absolute bottom-0 end-0 mb-n6 me-n6 d-none d-xl-block rtl:-scale-x-100">
            <svg
              class="fill-white"
              width="170"
              height="133"
          ...
          >
            ...
            <p class="text-dark mb-0">
              اطلاعات خود را به‌روز نگه‌دارید تا تعداد تقاطع‌ها افزایش یابد
            </p>
          </b-col>

          <img :src="about6" class="rounded position-relative" alt="about-img" />
        </b-col>

        <b-col lg="6" class="ms-auto position-relative order-lg-2">
          <h2 class="mb-4 mb-md-5">آزمون دسترسی سریع و مؤثر</h2>
          <p class="mb-4 mb-md-5">
            محتوای دیجیتال خود را به‌طور مؤثر برای دسترسی ارزیابی کنید، مشکلات را شناسایی و به‌سرعت حل کنید تا تجربه‌ای فراگیر برای کاربران تضمین شود.
          </p>
          <b-accordion class="accordion-icon accordion-bg-light" id="accordionFaq">
            <b-accordion-item
              v-for="(item, idx) in featureContent"
              :key="idx"
              headerTag="p"
              class="mb-3"
              buttonClass="fw-semibold rounded collapsed"
              bodyClass="mt-3 pb-0"
              :title="item.title"
            >
              {{ item.description }}
      ...
      <hr class="my-6 opacity-1" />

      <b-row class="row-cols-2 row-cols-md-4 g-4 align-items-center">
        <b-col v-for="(item, idx) in counterData" :key="idx">
          <div class="d-flex justify-content-center">
            <h4 class="purecounter mb-0">
              <Vue3autocounter
                ref="counter"
                :startAmount="0"
                :endAmount="item.state"
                :suffix="item.suffix"
                :duration="3"
              />
            </h4>
...
import { featureContent, counterData } from '@/views/pages/saas/Feature/data'
