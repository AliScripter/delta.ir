      ...
      <b-row class="g-4">
        <b-col lg="6" class="mb-sm-6 mb-lg-0">
          ...
          <b-row class="g-4 mb-4 mb-sm-5">
            <b-col sm="6" v-for="(item, idx) in features" :key="idx">
              <div class="d-flex mb-4 mb-sm-5">
                ...
                >
                  <component :is="item.icon" class="fa-xl" />
                </div>

                <div class="ms-3">
                  <h6 class="mb-0 mb-sm-2">{{ item.title }}</h6>
              ...
              <div class="d-flex">
                <div
                  class="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle"
                >
                  <component :is="item.icon1" class="fa-xl" />
                </div>

                <div class="ms-3">
                  <h6 class="mb-0 mb-sm-2">{{ item.title1 }}</h6>
          ...
          <b-row>
            <b-col lg="11" xl="9" class="position-relative ms-auto">
              ...
              <b-card no-body class="border p-4">
                ...
                <img :src="about07" class="card-img mb-3" alt="card img" />
              ...
              >
                <li class="list-inline-item me-0">
                  <a class="btn btn-xs btn-icon bg-facebook" href="#"
                    ><font-awesome-icon :icon="faFacebookF" class="lh-base"
                  /></a>
                </li>
                <li class="list-inline-item me-0">
                  <a class="btn btn-xs btn-icon bg-instagram" href="#"
                    ><font-awesome-icon :icon="faInstagram" class="lh-base"
                  /></a>
                </li>
                <li class="list-inline-item me-0">
                  <a class="btn btn-xs btn-icon bg-twitter" href="#"
                    ><font-awesome-icon :icon="faTwitter" class="lh-base"
                  /></a>
                </li>
                <li class="list-inline-item me-0">
                  <a class="btn btn-xs btn-icon bg-linkedin" href="#"
                    ><font-awesome-icon :icon="faLinkedin" class="lh-base"
                  /></a>
                </li>
                <li class="list-inline-item me-0">
                  <a class="btn btn-xs btn-icon bg-youtube" href="#"
                    ><font-awesome-icon :icon="faYoutube" class="lh-base"
                  /></a>
                </li>
              </ul>
            </b-col>
...
import { features } from '@/views/pages/saas/Feature/data'
import {
  faFacebookF,
  faInstagram,
  faLinkedin,
