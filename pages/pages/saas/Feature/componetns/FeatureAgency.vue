<template>
  <section class="bg-dark position-relative overflow-hidden" data-bs-theme="dark">
    <figure class="position-absolute top-0 start-0 mt-n6 ms-n8 rtl:-scale-x-100">
      <svg
        class="opacity-3"
        width="371"
        height="354"
    ...
    <figure class="position-absolute top-0 end-0 me-n9 mt-n7 d-none d-md-block rtl:-scale-x-100">
      <svg
        class="fill-white"
        width="768.8px"
        height="1386px"
        viewBox="0 0 768.8 1386"
        style="enable-background: new 0 0 768.8 1386; opacity: 0.07"
        xml:space="preserve"
      >
        <path
    ...
    <b-container class="pb-6 position-relative">
      <div class="inner-container-small text-center mb-4 mb-sm-5">
        <span class="text-primary fw-bold text-uppercase">ویژگی‌ها</span>
        <h2 class="mb-0 mt-3">ویژگی‌های قدرتمند SaaS برای آژانس شما</h2>
      </div>

      <b-row>
        <b-col lg="10" xl="8" xxl="6" class="mx-auto mb-6 mb-xl-8">
          <div class="bg-light rounded-pill p-2">
            <ul class="nav nav-pills nav-pills-primary nav-responsive justify-content-between">
              <li class="nav-item" role="presentation">
                <button
                  class="nav-link rounded-pill icons-center"
                  id="pills-analytics-tab"
                  @click="feature = 'analytics'"
                  :class="feature === 'analytics' && 'active'"
                >
                  <BIconFunnel class="me-2" />تحلیل داده‌ها
                </button>
              </li>
              <li class="nav-item" role="presentation">
                <button
                  class="nav-link rounded-pill icons-center"
                  id="pills-collaboration-tab"
                  @click="feature = 'collaboration'"
                  :class="feature === 'collaboration' && 'active'"
                >
                  <BIconBasket class="me-2" />همکاری
                </button>
              </li>
              <li class="nav-item position-relative" role="presentation">
                <span
                  class="badge text-bg-danger position-absolute top-0 start-100 translate-middle mt-n2 ms-n5 d-none d-lg-block"
                  >به زودی</span
                >
                <button class="nav-link rounded-pill icons-center" id="pills-automation-tab">
                  <BIconGear class="me-2" />خودکارسازی
                </button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link rounded-pill icons-center" id="pills-scalability-tab">
                  <BIconPieChart class="me-2" />قابلیت مقیاس‌پذیری
                </button>
              </li>
            </ul>
          </div>
        ...
        <b-col cols="11" class="mx-auto">
          <div class="tab-content" id="pills-tabContent">
            <div
              class="tab-pane fade"
              :class="feature === 'analytics' && 'active show'"
              id="pills-analytics"
              role="tabpanel"
            ...
            >
              <b-row class="align-items-center">
                <b-col lg="6" class="mb-6 mb-lg-0">
                  <span
                    class="bg-primary bg-opacity-10 text-primary text-uppercase rounded small px-3 py-2"
                    >تحلیل داده‌ها</span
                  >
                  <h3 class="my-4">تجزیه و تحلیل داده‌ها و گزارش‌گیری جامع</h3>
                  <p>
                    بینش‌های ارزشمندی درباره کمپین‌های دیجیتال خود با ویژگی‌های جامع تجزیه و تحلیل داده‌ها و گزارش‌گیری ما کسب کنید.
                  </p>
                  <ul class="list-group list-group-borderless mb-4">
                    <li class="list-group-item heading-color mb-0 icons-center">
                      <BIconPatchCheckFill class="text-primary me-2" />پیشنهادات قابل اقدام
                    </li>
                    <li class="list-group-item heading-color mb-0 icons-center">
                      <BIconPatchCheckFill class="text-primary me-2" />تحلیل چندکاناله
                    </li>
                    <li class="list-group-item heading-color mb-0 icons-center">
                      <BIconPatchCheckFill class="text-primary me-2" />رابط کاربری دوستانه
                    </li>
                  </ul>
                  <a class="btn btn-white icon-link icon-link-hover" href="#"
                    >تحلیل‌ها را بررسی کنید
                    <BIconArrowRight class="bi rtl:-scale-x-100" />
                  </a>
                </b-col>

                <b-col lg="4" class="position-relative ms-auto">
                  <figure class="position-absolute top-0 start-0 ms-n5 mt-n5">
                    <svg
                      class="opacity-2"
                      width="148"
                      height="140"
                  ...
                  <figure
                    class="position-absolute bottom-0 end-0 z-index-1 mb-n6 me-n6 d-none d-lg-block rtl:-scale-x-100"
                  >
                    <svg
                      width="167"
                      height="107"
                  ...
                  <img
                    :src="about14"
                    class="rounded position-relative zindex-2"
                    alt="feature-img"
                  />

                  <div
                    class="bg-white rounded d-flex align-items-center position-absolute top-0 end-0 mt-n5 px-3 py-2"
                  >
                    <p class="text-dark fw-bold mb-0">دیدار با</p>
                    <ul class="mb-0 align-items-center">
                      <li class="avatar avatar-xs me-1">
                        <img class="avatar-img rounded-circle" :src="avatar6" alt="avatar" />
                      </li>
                      <li class="avatar avatar-xs">
                        <img class="avatar-img rounded-circle" :src="avatar5" alt="avatar" />
                      </li>
                    </ul>
                  </div>

                  <b-card class="position-absolute bottom-0 start-0 ms-lg-n8 mb-n5">
                    <p>مشتریان عزیز ما</p>
                    <div class="d-flex align-items-center">
                      <ul class="avatar-group mb-0 align-items-center">
                        <li class="avatar avatar-xs" v-for="(image, idx) in customers" :key="idx">
            ...
            <div
              ...
              :class="feature === 'collaboration' && 'active show'"
              tabindex="0"
            >
              <b-row class="align-items-center">
                <b-col lg="6" class="mb-6 mb-lg-0">
                  <span
                    ...
                    >همکاری</span
                  >
                  <h3 class="my-4">کار گروهی ساده و تعامل با مشتریان</h3>
                  <p class="mb-5">
                    ویژگی همکاری ما آژانس شما را با کار گروهی بی‌درز و تعامل بهتر با مشتریان توانمند می‌سازد.
                  </p>
                  <b-row class="g-4 mb-5">
                    <b-col sm="6">
                      <p class="heading-color icons-center mb-3">
                        <BIconDiagram3 class="fa-xl text-primary me-3" />داده‌های خود را سازماندهی کنید
                      </p>
                      <p class="heading-color icons-center mb-0">
                        <BIconBoxes class="fa-xl text-primary me-3" />تحلیل‌های جاسازی شده
                      </p>
                    </b-col>

                    <b-col sm="6">
                      <p class="heading-color icons-center mb-3">
                        <BIconPeople class="fa-xl text-primary me-3" />با هر تیمی کار کنید
                      </p>
                      <p class="heading-color icons-center mb-0">
                        <BIconShieldCheck class="fa-xl text-primary me-3" />همکاری امن
                      </p>
                    </b-col>
                  </b-row>
                  <a class="btn btn-white icon-link icon-link-hover" href="#"
                    >مزایای همکاری را بررسی کنید
                ...
                <b-col lg="4" class="position-relative ms-auto">
                  <b-col
                    md="8"
                    class="position-absolute top-50 start-0 translate-middle mt-xl-n9 d-none d-lg-block"
                  >
                    <div class="bg-body rounded p-3">
                      <div class="bg-light d-flex align-items-center rounded w-100 p-2 mb-3">
                        <div
                          class="icon-md bg-primary flex-centered bg-opacity-10 rounded-circle text-primary flex-shrink-0"
                        >
                          <BIconCheck class="fs-5" />
                        </div>
                        <p class="heading-color mb-0 ms-2">
                          از آنجا که می‌تواند استفاده کند، ادامه می‌دهد.
                        </p>
                      </div>
                      ...
                      <div class="bg-light d-flex align-items-center rounded w-100 p-2 mb-3">
                        ...
                        <p class="heading-color mb-0 ms-2">تمام تصمیمات اولیه باید انجام شوند.</p>
                      </div>

                      <div class="bg-light d-flex align-items-center rounded w-100 p-2">
                        <div
                          class="icon-md bg-primary flex-centered bg-opacity-10 rounded-circle text-primary flex-shrink-0"
                        >
                          <BIconCheck class="fs-5" />
                        </div>
                        <p class="heading-color mb-0 ms-2">نوع جدا شده.</p>
                      </div>
                    </div>
                  </b-col>

                  <div
                    class="d-inline-block bg-white shadow rounded-4 position-absolute end-0 bottom-0 p-3 mb-n5 me-lg-n6 d-none d-sm-block"
                  >
                    <img :src="trustPilotImg" class="light-mode-item h-20px mb-2" alt="Client-img" />
                    <img :src="trustPilotLightImg" class="dark-mode-item h-20px mb-2" alt="Client-img" />
                    <div class="d-flex align-items-center">
                      <img :src="trustStarImg" class="h-30px" alt="rating-img" />
                      <h6 class="font-base fw-bold heading-color ms-1 mb-0">4.8/5.0</h6>
                    </div>
                    <p class="text-dark small mb-0 mt-2">بازخورد ۳۶۵ کاربر</p>
                  </div>

                  <figure class="position-absolute top-0 end-0 mt-n7 me-lg-n5 rtl:-scale-x-100">
                    <svg
                      width="120.4px"
                      height="124.5px"
                      viewBox="0 0 120.4 124.5"
                      style="enable-background: new 0 0 120.4 124.5"
                      xml:space="preserve"
                    >
                      <path
                        class="fill-mode"
                      ...
                      <path
                        class="fill-primary"
                        d="M82.8,6.5c0,0,0,0.1,0,0.1C82.8,6.6,82.8,6.6,82.8,6.5C82.9,6.6,82.8,6.5,82.8,6.5z"
                      ></path>
                    </svg>
                  </figure>

                  <img :src="about17" class="rounded" alt="feature-img" />
                </b-col>
              </b-row>
            </div>
          </div>
...
import trustpilotImgFA from '@/assets/images/elements/trustpilot-fa.svg'
import trustpilotLightImgFA from '@/assets/images/elements/trustpilot-light-fa.svg'
import trustStarImg from '@/assets/images/elements/trustpilot-star.svg'

const lang: string | undefined = inject('lang')

const trustPilotImg = lang === 'fa' ? trustpilotImgFA : trustpilotImgEN;
const trustPilotLightImg = lang === 'fa' ? trustpilotLightImgFA : trustpilotLightImgEN;

const customers = [avatar2, avatar3, avatar4, avatar5, avatar6]

const feature = ref('analytics')
</script>
