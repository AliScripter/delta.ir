      ...
      <b-row class="align-items-center">
        <b-col md="7" xl="6" class="mb-6 mb-md-0">
          <span class="bg-primary bg-opacity-10 text-primary text-uppercase rounded small px-3 py-2"
            >تحلیل داده‌ها</span
          >
          <h1 class="h2 my-4">تجزیه و تحلیل داده‌ها و گزارش‌گیری جامع</h1>
          <p class="mb-7">
            بینش‌های ارزشمندی درباره کمپین‌های دیجیتال خود با ویژگی تحلیلی داده‌ها و گزارش‌گیری جامع ما کسب کنید.
          </p>

          <h6 class="text-white fw-normal mb-4">بیش از ۵۰۰ تیم از میزل استفاده می‌کنند</h6>
          ...
          >
            <SwiperSlide v-for="item in swiper" :key="item">
              <img :src="item" class="pe-sm-3" alt="client-img" />
            </SwiperSlide>
          </Swiper>
        </b-col>

        <b-col md="4" class="position-relative ms-auto mb-xl-n9">
          <figure class="position-absolute bottom-0 end-0 z-index-1 mb-n6 me-n6 d-none d-lg-block rtl:-scale-x-100">
            <svg
              width="167"
              height="107"
              viewBox="0 0 167 107"
          ...
          <img :src="about14" class="rounded position-relative zindex-2" alt="feature-img" />

          <div
            class="bg-white rounded d-flex align-items-center position-absolute top-0 end-0 mt-n5 px-3 py-2 d-none d-lg-block"
          >
