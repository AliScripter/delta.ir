  ...
  <section class="position-relative z-index-2 pt-0">
    <b-container class="position-relative">
      <div class="bg-dark rounded position-relative overflow-hidden p-4 p-sm-7">
        <figure class="position-absolute top-0 start-0 mt-n5 rtl:-scale-x-100">
          <svg
            class="fill-white"
            style="opacity: 0.02"
            width="662"
        ...
        <figure class="position-absolute top-0 end-0 mt-n5 me-n5 rtl:-scale-x-100">
          <svg
          ...
          <b-col lg="10" xl="7" class="mx-auto text-center">
            ...
            <b-form class="col-md-10 bg-white bg-opacity-10 rounded-2 mx-auto p-2 mb-5">
              <div class="input-group">
                <b-form-input
                  class="focus-shadow-none bg-transparent text-white border-0 me-1"
                  type="email"
