      ...
      <b-row class="w-100 m-auto">
        <b-col sm="10" class="my-5 m-auto">
          ...
          <b-row class="mt-5">
            ...
            <b-col xxl="6" class="d-grid">
              <a href="#" class="btn border bg-light mb-0 flex-centered gap-1">
                <font-awesome-icon :icon="faFacebookF" class="text-facebook me-2" />ثبت نام با فیسبوک</a
              >
            </b-col>
          ...
          <b-form @submit.prevent="handleSignIn">
            ...
            <div class="mb-4 d-flex justify-content-between">
              <div class="form-check">
                ...
                <label class="form-check-label" for="checkbox-1">مرا به خاطر بسپار</label>
              </div>
            ...
            <div class="align-items-center mt-0">
              <div class="d-grid">
                <b-button variant="dark" class="mb-0" type="submit">ورود</b-button>
              </div>
            </div>
          </b-form>
          ...
          <div class="mt-4 text-center">
            <span
              >هنوز ثبت‌نام نکرده‌اید؟<router-link :to="{ name: 'auth.sign-up' }">
