        ...
        <b-col lg="10" class="my-5 m-auto">
          ...
          <h2 class="mb-0">
            ...
            <span class="position-relative"
              >حساب
              <span
                class="position-absolute top-50 start-50 translate-middle z-index-n1 ms-n2 mt-2 d-none d-sm-block rtl:-scale-x-100"
              >
                <svg
                  width="150.1px"
                  height="20.7px"
                  viewBox="0 0 150.1 20.7"
                  style="enable-background: new 0 0 150.1 20.7"
                  xml:space="preserve"
                >
                  <path
                    class="fill-primary"
          ...
          <p class="mb-0">بیایید با ۳۰ روز آزمایشی رایگان شما شروع کنیم</p>
          ...
          <b-row class="mt-5">
            ...
            <b-col xxl="6" class="d-grid">
              <a href="#" class="btn border bg-light mb-0"
                ><font-awesome-icon
                  :icon="faFacebookF"
                  class="fab fa-fw text-facebook me-2"
                />ثبت‌نام با فیسبوک</a
              >
            </b-col>
          ...
          <b-form>
            ...
            <PasswordInput name="password" v-model="newPassword" class="mb-4" />
            ...
            <div class="mb-4">
              <b-form-checkbox
                >من با تمام شرایط و ضوابط و سیاست حفظ حریم خصوصی موافقم.</b-form-checkbox
              >
            </div>
            <div class="align-items-center mt-0">
              <div class="d-grid">
                <b-button variant="dark" class="mb-0" type="button">ایجاد حساب کاربری</b-button>
              </div>
            </div>
          </b-form>
          ...
          <div class="mt-4 text-center">
            <span
              >قبلاً حساب دارید؟<router-link :to="{ name: 'auth.sign-in' }">
                اینجا وارد شوید</router-link
              ></span
            >
          </div>
        </b-col>
