...
import indianFlag from '@/assets/images/flags/in.svg'
import type { FAQType, FeatureType, TestimonialType } from '@/types'
...
export const feature: FeaturesType[] = [
  {
    title: 'محرک نوآوری',
    ...
    description: 'حضور دیجیتال خود را با رویکرد نوآورانه ما ارتقا دهید',

    title1: 'رویکرد شفاف',
    icon1: `<svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    description1: "در آژانس دیجیتال ما، شفافیت تنها یک واژه تبلیغاتی نیست."
  },
  {
    title: 'فناوری قابل دسترس',
    icon: ` <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    description: 'فراگیری را با فناوری مدرن و در دسترس تجربه کنید',

    title1: 'کار تیمی همکارانه',
    icon1: ` <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    description1: 'ما معتقدیم که بهترین نتایج از هم‌افزایی تنوع‌ها به دست می‌آید.'
  }
]

export const avatars: string[] = [avatar1, avatar2, avatar3, avatar8, avatar7, avatar5]
...
export const testimonials: TestimonialType[] = [
  ...
  },
  {
    ...
    user: {
      ...
      avatar: avatar5,
      role: 'مدیر عامل و مدیر بلاگ‌زین'
    }
  },
  {
    comment:
  ...
  {
    comment:
      'من به شدت میزل را به هر کسی که به دنبال یک تم بوت‌استرپ با کیفیت بالا است، توصیه می‌کنم. دره به سوی بیست به طور مستقیم به من هدایت کرد. برای حل مشکلات صبحانه، به طور کامل یا به درستی.',
    user: {
...
export const accordion: FAQType[] = [
  {
  ...
  },
  {
    ...
    answer:
      'چگونه مردان به طور قابل توجهی دو رفتار را ترتیب دادند. او برای بالاترین دفاتر کار می‌کرد و به یک مرتع پاسخ داد. در روزنامه کشف نشد که به سمت شمال بود. تعصب مکرر مالکیت حل و فصل در یا ظاهر من را تحت تأثیر قرار داد. همسر خوشحال واضح بود. او خیرخواهی شادی را برای خود نداشت. ابتدا جوک‌ها به مقیاس پرداخته شدند. مضامین او پیروزی زیبایی را دنبال کرد. خانه‌ای که در آن به هیچ وجه دیده نشد. دعوت‌ها به نظر می‌رسید که در احساسات تکلف عادی ساکن است. اصلاح اصول اندوهگین. آیا مهربانی به سرعت انجام می‌شود. احترام به مقاله خانه را نقاشی کرده است.'
  },
  {
