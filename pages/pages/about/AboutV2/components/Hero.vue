      ...
      <b-row>
        <b-col xl="10" class="text-center mx-auto">
          <span class="font-heading heading-color d-inline-block bg-light px-3 py-2 rounded-3 mb-4"
            >🤩 چه چیزی ما را به جلو می‌برد</span
          >
          <h1 class="mb-4">ما یک آژانس مستقل برند، طراحی و ارتباطات هستیم.</h1>
          <p class="lead mb-0">
            ما یک آژانس بازاریابی خلاقانه با محوریت بینش و رفتارها هستیم. یک آژانس دیجیتال خلاقانه کامل که در زمینه‌های زیر تخصص دارد: تولید ویدئو، طراحی وب، برندینگ، استراتژی برند، بازاریابی محتوا و فیلم‌برداری هوایی.
          </p>
          ...
          <b-row class="g-4 mt-5 mx-auto align-items-end">
            <b-col md="5" class="position-relative">
              ...
              <figure class="position-absolute top-0 start-0 z-index-1 mt-n6 ms-n5 rtl:-scale-x-100">
                <svg
                  width="167"
                  height="107"
                  viewBox="0 0 167 107"
              ...
              <div class="text-end position-relative d-none d-md-block">
                <figure class="position-absolute top-0 start-50 ms-n7">
                  <svg
                    class="fill-mode rtl:-scale-x-100"
                    width="106px"
                    height="96px"
                    viewBox="0 0 106 96"
                    style="enable-background: new 0 0 106 96"
                    xml:space="preserve"
                  >
                    <path
                ...
                <img :src="about16" class="rounded mb-4 w-50" alt="about-img" />
              </div>
            </b-col>
            ...
            <b-col md="7" class="position-relative mb-n4">
              ...
              <b-card no-body class="overflow-hidden p-0">
                ...
                <div class="position-absolute end-0 bottom-0 m-3 z-index-2">
                  ...
                  >
                    <BIconYoutube class="text-danger fa-fw fa-xl me-2" />داستان ما را تماشا کنید
                  </CustomGLightbox>
                </div>
              </b-card>
            </b-col>
