<template>
  <section class="pt-7 pt-md-8 pt-xl-9">
    <b-container class="pt-5 pt-md-0">
      <b-row>
        <b-col lg="6" xl="5" class="mb-6 mb-lg-0">
          <div class="d-flex flex-column h-100">
            <h1 class="mb-4">اکتشاف قلب <span class="text-primary">میزل</span></h1>
            <p class="mb-5 mb-xl-0">
              ما ایده‌ها را به راه‌حل‌هایی تبدیل می‌کنیم که فراتر از انتظارات شماست. به داستان ما بپیوندید تا بفهمید چگونه.
            </p>
            ...
            <div class="mt-auto">
              ...
              <q class="h6 fw-semibold mb-0"
                >استفاده از تم میزل سفری بی‌وقفه از ابتدا تا انتها بوده است!</q
              >
              <p class="mb-0 mt-3 text-body-secondary">
                <span class="heading-color fw-normal">دنیس بارنت</span> مدیر عامل شرکت
              </p>

              <b-row class="row-cols-sm-2 mt-3">
                <div class="cols">
                  <hr class="mb-4" />
                  ...
                  <p class="heading-color mb-0">۱۴۲۱ جاده کوبورن هالو، متامورا، ایلینوی ۶۱۵۴۸.</p>
                </div>
        ...
        <b-col lg="6" xl="6" class="ms-auto h-100">
          <b-row class="align-items-center">
            <b-col cols="6" class="me-sm-n7">
              <div class="position-relative">
                <figure class="text-primary position-absolute top-0 start-0 mt-n5 ms-n5 rtl:-scale-x-100">
                  <svg
                    width="111"
                    height="71"
                    viewBox="0 0 111 71"
                ...
                <img :src="about17" class="rounded-4" alt="" />
              </div>
            </b-col>
            <b-col cols="6" class="position-relative">
              <b-card no-body class="overflow-hidden p-0 mb-4 mb-sm-7">
                <img :src="about18" class="card-img" alt="video-img" />
                ...
                <div class="card-img-overlay d-flex p-3">
                  <div class="m-auto">
                    <CustomGLightbox
                      ...
                      className="btn btn-lg btn-white btn-round stretched-link mb-0"
                    >
                      <font-awesome-icon :icon="faPlay" class="text-danger" />
                    </CustomGLightbox>
                  </div>
                </div>
              </b-card>

              <img :src="about14" class="rounded-4" alt="" />
            </b-col>
          </b-row>
        </b-col>
      </b-row>

      <b-row class="mt-6 mt-lg-8">
        <b-col md="10" class="text-center mx-auto">
          <p class="heading-color fw-semibold mb-4">استفاده شده توسط بهترین شرکت‌های جهان</p>
          ...
          >
            <SwiperSlide v-for="item in swiper" :key="item.href">
              <a :href="item.href" target="_blank">
                <img :src="item.img" class="grayscale px-sm-3 ps-0" alt="client-img" />
              </a>
            </SwiperSlide>
          </Swiper>
        </b-col>
...
import { swiper } from '@/views/pages/about/AboutV3/data'
