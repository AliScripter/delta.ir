          ...
          <b-col lg="4" class="mb-5 mb-lg-0">
            <div class="d-flex flex-column h-100">
              <ul class="list-group list-group-borderless mb-4">
                <li class="list-group-item text-white fs-5 fw-semibold d-flex p-0">نوآوری کنید.</li>
                <li class="list-group-item text-white fs-3 fw-semibold d-flex p-0">بالا ببرید.</li>
                <li class="list-group-item text-white fs-2 fw-semibold d-flex p-0">موفق شوید.</li>
              </ul>

              <div class="mt-auto">
                <a class="btn btn-lg btn-outline-white icon-link icon-link-hover" href="#"
          ...
          <b-col lg="8" xl="6" class="ms-auto">
            <b-card no-body class="p-4 p-sm-5">
              <b-card-header class="bg-transparent p-0">
                <h5>در اینجا مشتریان ما تجربه می‌کنند</h5>
              </b-card-header>
              ...
              <b-card-body class="p-0 pt-4">
                ...
                >
                  <SwiperSlide v-for="(item, idx) in testimonials" :key="idx" class="pb-5">
