  ...
  <section class="pt-0">
    <b-container>
      <div class="inner-container-small text-center">
        ...
        <h2>ما استخدام می‌کنیم!</h2>
        <p class="mb-4">تیم ما به سرعت در حال رشد است و ما همیشه به دنبال افراد باهوش هستیم.</p>

        <div class="d-grid d-sm-flex justify-content-center gap-2 gap-sm-4">
          <a href="#" class="btn btn-lg btn-light border mb-0">بیشتر بیاموزید</a>
          <router-link :to="{ name: 'career' }" class="btn btn-lg btn-dark border mb-0"
            >مشاهده موقعیت‌های شغلی باز</router-link
          >
        </div>
      </div>
    </b-container>
