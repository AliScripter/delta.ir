...
import type { StatisticType, StepType, UserType } from '@/types'
...
export const list: string[] = [
  'ایجاد ۵۰+ بخش منحصر به فرد',
  'سفارشی‌سازی بسیار آسان',
  'سرعت بارگذاری فوق‌العاده سریع',
  'کاملاً پاسخگو در هر دستگاهی'
]

export const counter: StatisticType[] = [
  {
    title: 'مشتریان خوشحال',
    number: 600,
    prefix: '+',
    description: 'مشتریان خوشحال'
  },
  {
    title: 'کاربران به‌دست‌آمده',
    number: 200,
    prefix: '+',
    description: 'کاربران به‌دست‌آمده'
  },
  {
    title: 'نظرات مثبت کاربران',
    number: 10,
    prefix: 'K+',
    description: 'نظرات مثبت کاربران'
  },
  {
...
export const items: StepType[] = [
  ...
  },
  {
    ...
    description: "در آژانس دیجیتال ما، شفافیت تنها یک واژه تبلیغاتی نیست."
  },
  {
  ...
  },
  {
    ...
    description: 'ما معتقدیم که بهترین نتایج از هم‌افزایی تنوع‌ها به دست می‌آید.'
  }
]
...
export const lists = {
  list1: [
    ...
    'فرم‌های تماس آسان برای استفاده'
  ],

  list2: ['تحلیل عملکرد', 'سرعت بارگذاری سریع', 'آزمایش شده در مرورگرهای اصلی']
}

export const list2 = ['تحلیل عملکرد', 'سرعت بارگذاری سریع', 'آزمایش شده در مرورگرهای اصلی']
