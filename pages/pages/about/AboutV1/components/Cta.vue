    ...
    <b-container class="position-relative">
      <div class="bg-dark rounded position-relative overflow-hidden p-4 p-sm-7">
        <figure class="position-absolute top-0 start-0 mt-n5">
          <svg
            class="fill-white rtl:-scale-x-100"
            style="opacity: 0.02"
            width="662"
            height="614"
            viewBox="0 0 662 614"
        ...
        <b-row class="g-4 position-relative">
          <b-col lg="10" xl="7" class="mx-auto text-center">
            <h3 class="text-white mb-3">فرصت را از دست ندهید - میلیون‌ها نفر به میزل پیوسته‌اند!</h3>
            ...
            <b-form class="col-md-10 bg-white bg-opacity-10 rounded-2 mx-auto p-2 mb-5">
              <div class="input-group">
                <b-form-input
                  class="form-control focus-shadow-none bg-transparent text-white border-0 me-1"
                  type="email"
                  placeholder="آدرس ایمیل شما"
                />
                <b-button variant="primary" class="rounded-2 mb-0">اشتراک‌گذاری</b-button>
              </div>
            </b-form>
