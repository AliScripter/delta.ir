...
export const feature: FeatureType[] = [
  ...
  },
  {
    ...
    title: 'عملکردهای پیشرفته',
    description: 'این قابلیت‌های پیشرفته برای ارائه خدمات به کاربران طراحی شده‌اند.'
  },
  {
    icon: BIconDisplay,
    title: 'هاست و دامنه رایگان شامل می‌شود',
    description: 'این به این معنی است که وقتی برای خدمات آن‌ها ثبت‌نام می‌کنید، فقط هاستینگ دریافت نمی‌کنید.'
  },
  {
    icon: BIconLightningCharge,
    title: 'عملکرد بالا',
    description: 'دستیابی به عملکرد بالا شامل عوامل و ملاحظات مختلف است.'
  }
]

export const client: { href: string, img: string }[] = [
