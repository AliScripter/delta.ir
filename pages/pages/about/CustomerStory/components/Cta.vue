          ...
          >
            ...
            <b-row class="position-relative m-auto">
              <b-col lg="8" class="mx-auto text-center">
                ...
                <h3 class="text-white mb-3">به جامعه ما بپیوندید</h3>
                ...
                <router-link :to="{ name: 'contact.v1' }" class="btn btn-light mb-0"
                  >هم‌اکنون اقدام کنید</router-link
                >
              </b-col>
            </b-row>
          </div>
        ...
        <b-col md="4">
          <b-card no-body class="overflow-hidden bg-light">
            <b-card-body class="p-4 text-center">
              <span>خواندن داستان دیگر</span>
              <h6 class="mt-3 mb-0">گالری داستان‌های مشتریان ما که با آن‌ها هم‌خوانی دارد</h6>
            </b-card-body>
