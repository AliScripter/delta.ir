<template>
  <section class="position-relative pt-8 pt-xl-9">
    <b-container class="position-relative z-index-1 mb-5 mb-lg-7 pb-sm-6">
      <b-row class="g-4 g-xxl-5">
        <b-col lg="10" xl="8" class="text-center mx-auto">
          <figure class="position-absolute start-0 bottom-0 ms-7 mb-8 rtl:-scale-x-100" :class="rtl ? '-rotate-33' : 'rotate-33'">
            <svg
              width="101.6px"
              height="94.6px"
              viewBox="0 0 101.6 94.6"
              style="enable-background: new 0 0 101.6 94.6"
              xml:space="preserve"
            >
              <path
                class="fill-primary"
          ...
          <div class="position-relative mb-5">
            <h1 class="display-5 mb-0 lh-sm-base">
              نگاهی به لیست <span class="text-primary">فرصت‌های همکاری</span> در
              <span class="position-relative"
                >&nbsp;میــــزل
                <span
                  class="position-absolute top-50 start-50 translate-middle z-index-n1 mt-1 d-none d-lg-block"
                >
                  <svg
                    width="219"
                    height="87"
                  ...
                  >
                    <path d="M214 6.5H5V81H214V6.5Z" stroke="#09B850" stroke-width="2" />
                    <path class="fill-mode" d="M209 0H219V10H209V0Z" />
                    <path class="fill-mode" d="M209 77H219V87H209V77Z" />
                    <path class="fill-mode" d="M0 0H10V10H0V0Z" />
                    <path class="fill-mode" d="M0 75H10V85H0V75Z" />
                  </svg>
                </span>
              </span>
              بیندازید
            ...
            <div
              class="position-absolute top-100 start-100 translate-middle ms-lg-7 ms-xl-6 d-none d-lg-block"
            >
              <div class="podition-relative">
                <small class="badge text-bg-dark rounded-pill">طراح</small>
                <span class="fs-5 position-absolute start-0 top-0 mt-n4 ms-n4" :class="rtl ? 'fa-rotate-30' : 'fa-rotate-270'">
                  <BIconCursorFill class="text-primary mb-1" />
                </span>
              </div>
            </div>
          </div>
          <p>
            به تیم پیشگامان دیجیتال ما بپیوندید، جایی که خلاقیت با نوآوری هم‌سو می‌شود. فرصت‌های شغلی هیجان‌انگیزی را در میزل کشف کنید و بخشی از شکل‌دهی آینده دیجیتال باشید.
          </p>
          <div class="bg-light border rounded-3 position-relative px-4 py-3 mt-5">
            <form class="row g-3 justify-content-center align-items-center">
              ...
              <b-col lg="2" class="d-grid">
                <a class="btn btn-dark mb-0" href="#"> <BIconSearch class="me-2" />جستجو </a>
              </b-col>
            </form>
          </div>
          <ul class="list-inline mb-0 mt-3 flex-centered flex-wrap gap-1">
            <li class="list-inline-item"><span class="text-secondary">پیشنهاد: </span></li>
            <li class="list-inline-item">
              <a class="text-primary-hover heading-color mb-lg-0" href="#">طراحی وب,</a>
            </li>
            <li class="list-inline-item">
              <a class="text-primary-hover heading-color mb-lg-0" href="#">بازاریابی دیجیتال,</a>
            </li>
            <li class="list-inline-item">
              <a class="text-primary-hover heading-color mb-lg-0" href="#">طراحی UI/UX,</a>
            </li>
            <li class="list-inline-item">
              <a class="text-primary-hover heading-color mb-lg-0" href="#">توسعه وب</a>
            </li>
          </ul>
        </b-col>
      </b-row>
    ...
    <Swiper
      ...
      wrapper-class="align-items-center"
    >
      <SwiperSlide v-for="(item, idx) in swiper" :key="idx">
        <img :src="item" class="rounded" alt="" />
      </SwiperSlide>
    </Swiper>
  </section>
</template>
...
import { swiper } from '@/views/pages/about/Career/data'
import { BIconBriefcase, BIconCursorFill, BIconGeoAlt, BIconSearch } from 'bootstrap-icons-vue'

const rtl: boolean | undefined = inject('rtl')

const selected = ref(null)
const options = [
  { value: null, text: 'موقعیت' },
  { value: 'Canada', text: 'کانادا' },
  { value: 'USA', text: 'ایالات متحده' },
  { value: 'Paris', text: 'پاریس' },
  { value: 'India', text: 'هند' },
  { value: 'London', text: 'لندن' }
]
</script>
