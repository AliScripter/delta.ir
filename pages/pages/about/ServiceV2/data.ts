...
import type { FAQType, StepType } from '@/types'

export const cards: StepType[] = [
  {
    title: 'بازاریابی دیجیتال',
    description:
      'بازاریابی دیجیتال هنر و علمی است برای دستیابی، تعامل و تأثیرگذاری بر مخاطبان هدف شما از طریق کانال‌های آنلاین.',
  ...
  },
  {
    title: 'طراحی وب',
    description:
      "یک وب‌سایت به‌خوبی طراحی‌شده نه تنها بازدیدکنندگان را جذب می‌کند بلکه هویت برند را نیز منتقل می‌کند و در نهایت منجر به تعامل و تبدیل‌ها می‌شود.",
    icon: `<svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description:
      "برنامه‌ریزی استراتژیک فرآیند عمدی تعریف اهداف و مقاصد یک سازمان است.",
    icon: ` <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    title: 'طراحی برند',
    description:
      'طراحی برند فرآیند خلاقانه‌ای است برای ایجاد هویت بصری و احساسی که نمایانگر کسب‌وکار شما باشد.',
    icon: ` <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description:
      'تحلیل پایگاه داده شامل بررسی سیستماتیک مجموعه‌های داده ساختاریافته برای استخراج بینش‌های ارزشمند، الگوها و روندها است.',
    icon: ` <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description:
      'مشاوران عملیات شما را تحلیل می‌کنند، توصیه‌های استراتژیک ارائه می‌دهند، به اجرای راه‌حل‌ها برای مقابله با چالش‌ها کمک می‌کنند و رشد را تحریک می‌کنند.',
    icon: ` <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const accordion: FAQType[] = [
  ...
  {
    question: 'آیا می‌توانم از این قالب برای مشتری خود استفاده کنم؟',
    answer:
  ...
  {
    question: 'آیا قالب‌هایی در دسته‌بندی‌های دیگر ارائه می‌دهید؟',
    answer:
  ...
  {
    question: 'آیا باید هنگام استفاده از این قالب به شما اعتبار بدهم؟',
    answer:
      'اما او آماده‌ترین حداقل مجموعه‌ای زندگی کرد علی‌رغم صلب. سپتامبر چگونه مردان به‌طور قابل قبول دو رفتار ترتیب دادند. او دفاتر برای بالاترین رتبه‌ها و یکی را پاسخ داد که مرتع تلاش کرد. کشف در روزنامه به هیچ وجه تحسین نشد. پیوسته تمایل مالکیت حل و فصل در یا ظاهر بی‌تأثیر من. درگیر بود که شوهر راضی مشهود بود. آری، خوشبختی صلاحیت انجام دادن هیچ مسکن. اول ام شوخی‌های صفحه شروع شد تا علت مقیاس شود. موضوعات او پیش‌بینی شکوه دنبال نکرد هیچ بر آن پیروز نشد. بهبود داده‌های خود برکت ممکن است خاص خانگی. چشم‌انداز خانه هرگز رابطه ندارد. نه بازدید کرده بالا بردن گرانش خارجی موضوع کلبه من آقای باشد.'
  }
]
