<template>
  <section class="pt-7 pt-md-8">
    <b-container class="pt-4 pt-md-0">
      <b-row class="justify-content-between">
        <b-col lg="6" class="mb-6 mb-lg-0">
          <div class="d-flex flex-column h-100">
            <h1 class="mb-3">برای اطلاعات بیشتر با ما در تماس باشید</h1>
            <p class="mb-0">شما می‌توانید هر زمان از طریق <a href="#">example@gmail.com</a> با ما تماس بگیرید</p>

            <div class="d-sm-flex gap-3 align-items-center my-5">
              <h6 class="mb-3 mb-sm-0">ما را دنبال کنید در:</h6>
              <ul class="list-inline flex-wrap mb-0 hstack gap-1">
                <li class="list-inline-item">
                  <a href="#" class="btn btn-icon btn-light text-facebook rounded-circle">
                    <BIconFacebook />
                  </a>
                </li>
                <li class="list-inline-item">
                  <a href="#" class="btn btn-icon btn-light text-instagram rounded-circle">
                    <BIconInstagram />
                  </a>
                </li>
                <li class="list-inline-item">
                  <a href="#" class="btn btn-icon btn-light text-dribbble rounded-circle">
                    <BIconDribbble />
                  </a>
                </li>
                <li class="list-inline-item">
                  <a href="#" class="btn btn-icon btn-light text-twitter rounded-circle">
                    <BIconTwitter />
                  </a>
                </li>
                <li class="list-inline-item">
                  <a href="#" class="btn btn-icon btn-light text-youtube rounded-circle">
                    <BIconYoutube />
                  </a>
                </li>
              </ul>
        ...
        <b-col lg="6" xl="5">
          <b-card no-body class="card-body shadow border p-sm-5">
            ...
            <b-form class="row g-4">
              <b-col md="6">
                <b-form-group label="نام شما *" label-for="name" label-class="heading-color">
                  <b-form-input type="text" class="form-control-lg" placeholder="نام کامل"
                /></b-form-group>
              </b-col>

              <b-col md="6">
                <b-form-group label="آدرس ایمیل *" label-for="email" label-class="heading-color">
                  <b-form-input
                    type="email"
              ...
              <b-col md="6">
                <b-form-group label="شماره تلفن *" label-for="number" label-class="heading-color">
                  <b-form-input type="text" class="form-control-lg" placeholder="(xxx) xx xxxx"
                /></b-form-group>
              </b-col>

              <b-col md="6">
                <b-form-group label="شرکت *" label-for="company" label-class="heading-color">
                  <b-form-input type="text" class="form-control-lg" placeholder="نام شرکت"
                /></b-form-group>
              </b-col>
              ...
              <b-button class="mb-0" variant="primary" size="lg">ارسال پیام</b-button>
            </b-form>
          </b-card>
        </b-col>
      </b-row>
...
import { swiper } from '@/views/pages/contact/data'
import {
  BIconFacebook,
  BIconInstagram,
  BIconDribbble,
