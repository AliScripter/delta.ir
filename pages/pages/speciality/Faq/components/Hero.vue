<template>
  <section class="pt-lg-8">
    <b-container class="pt-4 pt-lg-0">
      <b-row class="g-4 g-xl-6 align-items-center">
        <b-col md="6">
          <h1 class="mb-4">سوالات متداول</h1>
          <p class="mb-0">
            به کمکی نیاز دارید؟ در اینجا پرسش‌های متداول ما آورده شده است.
          </p>

          <b-col cols="10" class="mt-4">
            <b-form class="position-relative">
              <b-form-input
                class="form-control-lg bg-light ps-6"
                type="search"
              ...
              <b-button
                :variant="null"
                class="px-3 py-0 position-absolute top-50 start-0 translate-middle-y flex-centered"
                type="submit"
              >
                <BIconSearch class="fs-6" />
              </b-button>
            </b-form>
          </b-col>
        </b-col>
        ...
        <b-col md="6">
          <svg
            ...
            style="enable-background: new 0 0 502.3 300.7"
            xml:space="preserve"
          >
            <path
              class="fill-primary"
            ...
            <path
              class="fill-mode opacity-9"
              d="M143.3,277.9l1.9,21.2H36.1c0,0,5-29.3,8.3-31.5C47.8,265.4,143.3,277.9,143.3,277.9z"
            />
            <path
              class="fill-mode opacity-9"
            ...
            <path
              class="fill-mode opacity-9"
              d="M107.9,105.4c0,0,0.5,7.3,6.4,14.2l0.8-9.1L107.9,105.4z"
            />
            <path
              class="fill-mode opacity-9"
            ...
            <path
              class="fill-mode opacity-9"
              d="M312.8,264.6c0,1.6-1.4,3-3,3s-3-1.4-3-3s1.4-3,3-3S312.8,263,312.8,264.6z"
            />
            <path
              class="fill-mode opacity-9"
            ...
            <path
              class="fill-mode opacity-9"
              d="M436.6,290.9l-111.4,5.2l-1.4-5l58.4-89.4l112.8-0.1l5,2.8L436.6,290.9z"
            />
            ...
            <path
              class="fill-mode opacity-9"
              d="M290.4,299.1l153.5-0.1v-8.1l-148.2,0.1c-3,0-5.3,2.4-5.3,5.3V299.1z"
            />
            <path
              class="fill-mode opacity-9"
