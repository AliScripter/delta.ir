      ...
      <div class="bg-primary bg-opacity-10 rounded p-4 p-sm-5">
        <b-row>
          <b-col lg="7" class="text-center mx-auto">
            ...
            <h4>هنوز سوالی دارید؟</h4>
            <p class="mb-4">
              ما خوشحال می‌شویم که به هر سوالی که دارید کمک کنیم! لطفاً به ما بگویید
              به دنبال چه چیزی هستید و ما بهترین تلاش خود را برای کمک به شما خواهیم کرد.
            </p>

            <router-link :to="{ name: 'contact.v1' }" class="btn btn-lg btn-dark mb-0"
