<template>
  <footer class="bg-dark position-relative overflow-hidden pb-0 pt-6 pt-lg-8" data-bs-theme="dark">
    <figure class="position-absolute top-0 start-0 mt-n8 ms-n9 rtl:-scale-x-100">
      <svg
        class="fill-mode"
        width="775px"
        height="834px"
    ...
    <div class="position-absolute top-0 end-0 mt-n3 me-n4 rtl:-scale-x-100">
        ...
        >
          <template #button-content>
            ...
            <span class="icons-center"
              >زبان <font-awesome-icon class="ms-2 fa-sm" :icon="faChevronUp" />
            </span>
          </template>
          <li>
            <b-dropdown-item class="me-4" href="#"
            ><img class="fa-fw me-2" :src="irFlag" alt="" />فارسی
            </b-dropdown-item>
          </li>
          <li>
            <b-dropdown-item class="me-4" href="#"
              ><img class="fa-fw me-2" :src="ukFlag" alt="" />انگلیسی
            </b-dropdown-item>
          </li>
          <li>
            <b-dropdown-item class="me-4" href="#"
              ><img class="fa-fw me-2" :src="grFlag" alt="" />آلمانی</b-dropdown-item
            >
          </li>
          <li>
            <b-dropdown-item class="me-4" href="#"
              ><img class="fa-fw me-2" :src="spFlag" alt="" />فرانسوی</b-dropdown-item
            >
          </li>
        </b-dropdown>
      </div>
