    ...
    <b-container>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-dots pb-0 mb-0">
          ...
          <li class="breadcrumb-item"><a href="#">تمام محصولات</a></li>
      ...
      <b-row class="mt-7">
        ...
        <b-col md="7" class="ps-md-6">
          <div class="badge text-bg-dark mb-3">فناوری</div>

          <h1 class="h2 mb-4">هوشمندترین گوشی برای سبک‌های زندگی مدرن</h1>
          ...
          <div class="d-flex align-items-center flex-wrap mb-4">
            ...
            <a href="#" class="heading-color text-primary-hover mb-0">345 بررسی</a>
            <span class="text-secondary opacity-3 mx-2 mx-sm-3">|</span>
            <span>86 فروش رفته</span>
          </div>

          <h4 v-if="lang==='en'" class="text-success mb-4">{{ currency }}215.00</h4>
          <h4 v-else-if="lang==='fa'" class="text-success mb-4">215.00 {{ currency }}</h4>

          <div class="d-flex align-items-center gap-1 gap-sm-3 flex-wrap mt-2 mb-4">
            <span class="d-block">حافظه ذخیره‌سازی:</span>
          ...
          <div class="color-check-radio d-flex align-items-center gap-3 mt-2 mb-4">
            <span class="d-block">انتخاب رنگ:</span>
            <div>
              <input
          ...
          <div class="d-flex align-items-center gap-3 mt-2 mb-4">
            <span class="d-block">انتخاب مقدار:</span>
            <b-col md="2">
          ...
          <p class="mb-4">
            با ویژگی‌ها و نوآوری‌های پیشرفته، این گوشی هوشمند بیشتر از یک ابزار ارتباطی است، بلکه یک همراه سبک زندگی است که با نیازهای شما هماهنگ می‌شود.
          </p>
          ...
          <div class="d-grid">
            ...
            <p class="mb-0 mt-2 text-end small flex-centered justify-content-end">
              ...
              نیاز به کمک دارید؟
              <router-link :to="{ name: 'contact.v2' }" class="mb-0 ms-1">گفتگو با ما</router-link>
            </p>
          </div>
        </b-col>
      </b-row>
