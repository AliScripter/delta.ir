<template>
  <section class="pt-0">
    <b-container>
      <h2 class="h4 mb-5">امتیاز و بررسی</h2>
      ...
      <b-row>
        <b-col lg="5" class="pe-lg-5 mb-5 mb-lg-0">
          <div class="border rounded-2 p-4">
            <b-row>
              <b-col md="5">
                ...
                <p class="mb-2">بر اساس 56 بررسی</p>
              </b-col>
          ...
          <div class="mt-5">
            <h5 class="mb-4">بررسی‌ها با تصاویر</h5>
          ...
          <template v-for="(review, idx) in reviews" :key="idx">
            ...
            <div class="d-flex">
              ...
              <div>
                <div class="d-sm-flex justify-content-between mb-2">
                  ...
                  <ul class="list-inline mb-0">
                    ...
                    <li v-if="!Number.isInteger(review.rating)" class="list-inline-item me-1">
                      <font-awesome-icon :icon="faStarHalfAlt" class="text-warning small rtl:-scale-x-100" />
                    </li>
                ...
                <span class="me-1">آیا مفید بود؟</span>
                <div
